...
subtitle: function(data) {
	const channels = ['Aynı Kanal', 'Etiketli Kanal', 'Serverın 1. Kanalı', 'Geçici Değişken', 'Sunucu Değişkeni', 'Evrensel Değişken'];
...
<div>
	<div style="float: left; width: 35%;">
		...
		<select id="condition" class="round" onchange="glob.onChange2(this)">
			...
			<option value="1">Komutu Kullananın</option>
