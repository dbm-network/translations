...
name: "Komut Parametrelerini Depola",
...
subtitle: function(data) {
	const infoSources = ['Tek Parametre', 'Çoklu Parametre ', 'Etiketli Üye', 'Etiketli Rol', 'Etiketli Kanal']
...
<div>
	<div style="float: left; width: 35%;">
		...
		<select id="info" class="round" onchange="glob.onChange1(this)">
			<option value="0" selected>Tek Parametre</option>
			<option value="1">Çoklu Parametre</option>
			<option value="2">Etiketli Üye</option>
			<option value="3">Etiketli Rol</option>
			<option value="4">Etiketli Kanal</option>
		</select>
	</div>
	<div style="float: right; width: 60%;">
		<div id="infoCountLabel">Parametre Sayısı:</div>
...
init: function() {
	...
	glob.onChange1 = function(event) {
		...
		switch(value) {
			case 0:
				infoCountLabel.innerHTML = 'Parametre Sayısı:';
				break;
			case 1:
				infoCountLabel.innerHTML = 'Parametre Sayısının Başlangıcı:';
				break;
			case 2:
				infoCountLabel.innerHTML = 'Etiketli Üye Sayısı:';
				break;
			case 3:
				infoCountLabel.innerHTML = 'Etiketli Rol Sayısı:';
				break
			case 4:
				infoCountLabel.innerHTML = 'Etiketli Kanal  Sayısı:';
				break;
			default:
