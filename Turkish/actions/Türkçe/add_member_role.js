...
subtitle: function(data) {
	const roles = ['Etiketli Rol', 'Yazanın 1. Rolü', 'Sunucunun 1. Rolü', 'Geçici Değişken', 'Sunucu Değişkeni', 'Evrensel Değişken'];
	const channels = ['Etiketli Kişi', 'Komut Sahibi', 'Geçici Değişken', 'Sunucu Değişkeni', 'Evrensel Değişken'];
