...
name: "Sunucunun Bölgesini Ayarla",
...
<div style="padding-top: 8px; width: 90%;">
	...
	<select id="region" class="round">
		...
		<option value="us-west">ABD batı</option>
		<option value="singapore">Singapur</option>
		<option value="eu-central">AB Merkezi</option>
		<option value="hongkong">HongKong</option>
		<option value="us-south">ABD Güney</option>
		<option value="us-central">ABD Merkez</option>
		<option value="london">London</option>
		<option value="us-east">ABD Doğu</option>
		<option value="sydney">Sidney</option>
		<option value="amsterdam">Amsterdam</option>
		<option value="eu-west">AB Batı</option>
