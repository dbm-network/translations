...
name: "Üyenin Sesli Kanalını Ayarla",
...
subtitle: function(data) {
	const members = ['Etiketli Kullanıcı', 'Komutu Yazan', 'Geçici Değişken', 'Sunucu Değişkeni', 'Evrensel Değişken'];
