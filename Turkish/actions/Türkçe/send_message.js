...
subtitle: function(data) {
	const channels = ['Aynı Kanal', 'Komutu Kullanan', 'Etiketli Kullanıcı', 'Etiketli Kanal', 'Varsayılan Kanal', 'Geçici Değişken', 'Server Değişkeni', 'Global Değişkeni'];
...
<div style="padding-top: 8px;">
	Mesaj:<br>
	<textarea id="message" rows="9" placeholder="Mesajını Buraya Gir..." style="width: 99%; font-family: monospace; white-space: nowrap; resize: none;"></textarea>
</div><br>
<div>
	<div style="float: left; width: 35%;">
		Depola:<br>
