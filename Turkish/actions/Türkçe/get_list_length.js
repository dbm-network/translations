...
subtitle: function(data) {
	const list = ['Sunucu Üyeleri', 'Sunucu Kanalları', 'Sunucu Rolleri', 'Sunucu Emojisi', 'Tüm Bot Sunucuları', 'Etiketlenen Kişinin Rolleri ', 'Komutu Yazanın Rolleri', 'Geçici Değişken', 'Sunucu Değişkeni', 'Evrensel Değişken'];
