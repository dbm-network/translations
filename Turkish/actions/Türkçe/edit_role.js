...
subtitle: function(data) {
	const roles = ['Etiketlenen Rol', 'Yazarın 1.Rolü', 'Sunucunun 1.Rolü', 'Geçici Değişken', 'Sunucu Değişkeni', 'Evrensel Değişken'];
...
<div style="padding-top: 8px;">
	Ad:<br>
	<input id="roleName" placeholder="Düzenlenmemesi için boş bırak!" class="round" type="text">
</div><br>
<div style="float: left; width: 50%;">
	Çevrimiçi Kullanıcılardan Ayrı Görüntüle:<br>
	<select id="hoist" class="round" style="width: 90%;">
		<option value="none" selected>Değiştirme</option>
		<option value="true">Evet</option>
		<option value="false">Hayır</option>
	</select><br>
	Etiketlenebilirlik:<br>
...
<div style="float: right; width: 50%;">
	Renk:<br>
	<input id="color" class="round" type="text" placeholder="Düzenlenmemesi için boş bırak!"><br>
	Konumu:<br>
	<input id="position" class="round" type="text" placeholder="Düzenlenmemesi için boş bırak!" style="width: 90%;"><br>
</div>`
},
