...
section: "Kullanımdan Kaldırıldı",
...
subtitle: function(data) {
	const members = ['Etiketli Kullanıcı', 'Komut Yazarı', 'Geçici Değişken', 'Sunucu Değişkeni', 'Evrensel Değişken'];
	const storage = ['', 'Geçici Değişken', 'Sunucu Değişkeni', 'Evrensel Değişken'];
...
<div style="padding-top: 8px;">
	...
	<div style="float: left; width: 60%;">
		Varsayılan Değer (veri mevcut değilse):<br>
