...
subtitle: function(data) {
	const info = ['Üye ID', 'Üyenin Kullanıcı Adı', 'Üyenin Görünen Adı', 'Üyenin Rengi'];
...
<div>
	<div style="float: left; width: 40%;">
		...
		<select id="info" class="round">
			<option value="0" selected>Üye ID</option>
			<option value="1">Üyenin Kullanıcı Adı</option>
			<option value="2">Üyenin Görünen Adı </option>
			<option value="3">Üyenin Rengi</option>
		</select>
	</div>
