...
name: "Kanal Yetkilerini Role Ayarla",
...
subtitle: function(data) {
	const names = ['Aynı Kanal', 'Etiketli Kanal', 'Varsayılan Kanal', 'Geçici Değişken', 'Sunucu Değişkeni', 'Evrensel Değişken'];
...
fields: ["channel", "varName", "role", "varName2", "permission", "state"],
...
<div style="padding-top: 8px;">
	...
	<div style="padding-left: 5%; float: left; width: 55%;">
		...
		<select id="state" class="round">
			<option value="0" selected>İzin Ver</option>
			<option value="1">Inherit</option>
			<option value="2">İzin Verme</option>
		</select>
	</div>
</div>`
},
