...
fields: ["URL", "aramak", "ses", "geçiş", "bithızı", "tür"],
...
<div style="float: right; width: 50%;">
	Ses (0 = min; 100 = max):<br>
	<input id="volume" class="round" type="text" placeholder="Otomatik olması için boş bırak..."><br>
	Bithızı:<br>
	<input id="bitrate" class="round" type="text" placeholder="Otomatik olması için boş bırak...">
</div><br><br><br><br><br><br><br>
<div>
	Oynatma Türü:<br>
	<select id="type" class="round" style="width: 90%;">
		<option value="0" selected>Listeye Ekle</option>
		<option value="1">Acilen Oynat</option>
	</select>
</div>`
},
