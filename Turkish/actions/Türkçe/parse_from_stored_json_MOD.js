module.exports = {
  ...
  name: "Stored Json'dan Ayrıştırma",
  ...
  short_description: "Açıklamanı buraya gir.",
	...
	<div id="main-body">
		...
		<div id="wrexdiv" style="width: 550px; height: 350px; overflow-y: scroll;">
			<div>
				<p>
					<u>Mod Bilgisi:</u><br>
					General Wrex tarafından Oluşturuldu! SeikiMatt Tarafından Düzenlendi ve Onarıldı!
				</p>
			</div>
			<div>
				<div><br>
					Stored JSON Değişken Adı: <br>
					<input id="jsonObjectVarName" class="round" style="width: 100%;" type="text"><br>
				</div><br>
				JSON Path: (kullanımını destekler <a href="http://goessner.net/articles/JsonPath/index.html#e2" target="_blank">JSON
					Path (Regex)</a>))<br>
				...
				<div>
					...
					<select id="behavior" class="round">
						<option value="0" selected>Sonraki İşlemi Otomatik Olarak Ara</option>
						<option value="1">Sonraki Eylemi Arama</option>
					</select>
				</div>
