...
subtitle: function(data) {
	const roles = ['Etiketli Rol', 'Komutu Yazanın 1. Rolü', 'Sunucunun 1. Rolü', 'Geçici Değişken', 'Sunucu Değişkeni', 'Evrensel Değişken'];
	const channels = ['Etiketlenen Kişi', 'Komutu Yazan', 'Geçici Değişken', 'Sunucu Değişkeni', 'Evrensel Değişken'];
