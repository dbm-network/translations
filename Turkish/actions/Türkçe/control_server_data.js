...
name: "Server Verisini kontrol Et",
...
subtitle: function(data) {
	const channels = ['Mevcut Sunucu', 'Geçici Değişken', 'Sunucu Değişkeni', 'Evrensel Değişken'];
...
<div style="padding-top: 8px;">
	...
	<div style="float: left; width: 45%;">
		...
		<select id="changeType" class="round">
			<option value="0" selected>Değeri Ayarla</option>
			<option value="1">Değere Ekle</option>
		</select>
	</div>
</div><br><br><br>
<div style="padding-top: 8px;">
