...
name: "Server'ın Sıçrama Ekranını Ayarla",
...
subtitle: function(data) {
	const storeTypes = ["", "Geçici Değişken", "Server Değişkeni", "Global Değişkeni"];
...
<div>
	<p>
		<u>Not:</u><br>
		Discord Sıçrama Ekranları Sadece Discord Partnerlarına Aktiftir.<br>
		Daha fazla bilgi için, kontrol edin <a href="#" onclick="glob.openLink('https://discordapp.com/partners')">https://discordapp.com/partners</a>.
	</p>
</div><br>
<div>
