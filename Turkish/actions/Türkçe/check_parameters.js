...
<div>
	<div style="float: left; width: 45%;">
		...
		<select id="condition" class="round">
			<option value="0" selected>Parametre sayısı ...</option>
			<option value="1">Bahsedilen Üye Sayısı...</option>
			<option value="2">Bahsedilen Kanal Sayısı...</option>
			<option value="3">Bahsedilen Rol Sayısı...</option>
		</select>
	</div>
