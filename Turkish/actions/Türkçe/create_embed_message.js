...
<div style="float: left; width: 50%;">
	...
	Yazar:<br>
	<input id="author" class="round" type="text" placeholder="Yazar istemiyorsan boş bırak!"><br>
	Renk:<br>
	<input id="color" class="round" type="text" placeholder="Varsayılan için boş bırak!"><br>
	Zaman Damgasını Kullan:<br>
...
<div style="float: right; width: 50%;">
	URL:<br>
	<input id="url" class="round" type="text" placeholder="Yoksa boş bırak!"><br>
	Yazar İkon URL:<br>
	<input id="authorIcon" class="round" type="text" placeholder="Yoksa boş bırak!"><br>
	Resim URL:<br>
	<input id="imageUrl" class="round" type="text" placeholder="Yoksa boş bırak!"><br>
	Küçük Önizleme  URL:<br>
	<input id="thumbUrl" class="round" type="text" placeholder="Yoksa boş bırak!"><br>
</div>
<div>
