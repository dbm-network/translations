...
<div style="float: left; width: 50%;">
	Bit Hızı:<br>
	<input id="bitrate" class="round" type="text" placeholder="Varsayılan için boş bırak!" style="width: 90%;"><br>
</div>
<div style="float: right; width: 50%;">
	Kullanıcı Limiti:<br>
	<input id="userLimit" class="round" type="text" placeholder="Varsayılan için boş bırak!" style="width: 90%;"><br>
</div>
<div>
