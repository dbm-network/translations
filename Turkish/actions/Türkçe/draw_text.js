...
<div style="float: left; width: 50%;">
	Yerel Yazı Tipi URL'si(.fnt):<br>
	<input id="font" class="round" type="text" value="fontlar/Asimov.fnt"><br>
	X Konumu:<br>
	<input id="x" class="round" type="text" value="0"><br>
</div>
<div style="float: right; width: 50%;">
	Maksimum Genişlik:<br>
	<input id="width" class="round" type="text" placeholder="Yoksa Boş Bırak!"><br>
	Y Konumu:<br>
	<input id="y" class="round" type="text" value="0"><br>
</div><br><br><br>
<div>
	Text:<br>
	<textarea id="text" rows="5" placeholder="Mesajı buraya girin..." style="width: 99%; white-space: nowrap; resize: none;"></textarea>
</div>`
},
