...
name: "Değişken Tipini Kontrol Et",
...
<div style="padding-top: 8px; width: 80%;">
		Kontrol Edilecek Değişken Tipi:<br>
		<select id="comparison" class="round">
			<option value="0" selected>Sayı</option>
			<option value="1">String</option>
			<option value="2">Resim</option>
			<option value="3">Üye</option>
			<option value="4">Mesaj</option>
			<option value="5">Yazı Kanalı</option>
			<option value="6">Ses Kanalı</option>
			<option value="7">Rol</option>
			<option value="8">Sunucu</option>
