module.exports = {
    ...
    short_description: "Ver Variable con más opciones.",
    ...
    <div style="padding-top: 8px;">
        <div style="float: left; width: 45%;">
            ...
            <select id="comparison" class="round" onchange="glob.onChange1(this)">
                <option value="0" selected>La longitud es más grande que</option>
                <option value="1">La longitud es menor que</option>
                <option value="2">Longitud igual a</option>
            </select>
        </div>
