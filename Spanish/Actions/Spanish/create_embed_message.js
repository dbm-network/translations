...
//---------------------------------------------------------------------
	 ...
	 short_description: "Categoría cambiada.",
...
<div style="float: left; width: 50%;">
	...
	Author:<br>
	<input id="author" class="round" type="text" placeholder="En blanco para desactivar el autor!"><br>
	Color:<br>
	<input id="color" class="round" type="text" placeholder="En blanco = por defecto"><br>
	Use Timestamp:<br>
...
<div style="float: right; width: 50%;">
	URL:<br>
	<input id="url" class="round" type="text" placeholder="Dejalo en blanco para nada!"><br>
	Author Icon URL:<br>
	<input id="authorIcon" class="round" type="text" placeholder="Dejalo en blanco para nada!"><br>
	Image URL:<br>
	<input id="imageUrl" class="round" type="text" placeholder="Dejalo en blanco para nada!"><br>
	Thumbnail URL:<br>
	<input id="thumbUrl" class="round" type="text" placeholder="Dejalo en blanco para nada!"><br>
</div>
<div>
