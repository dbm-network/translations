...
short_description: "Mira si el miembro cumple las condiciones.",
...
<div style="padding-top: 8px;">
	<div style="float: left; width: 35%;">
		Ver si el Miembro:<br>
		<select id="info" class="round">
			<option value="0" selected>Es un Bot</option>
			<option value="2">Es Kickeable</option>
			<option value="1">Es Baneable</option>
			<option value="4">Está en un Canal de Voz</option>
		</select>
	</div>
