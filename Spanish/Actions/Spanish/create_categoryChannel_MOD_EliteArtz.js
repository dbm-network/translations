...
//---------------------------------------------------------------------
	 ...
	 short_description: "Crea una Categoría (Canal)!",
...
html: function(isEvent, data) {
	...
	<div>
		<p>
			<u>Mod Info:</u><br>
			Creado Por EliteArtz!
		</p><br>
		<p>
			<u>Noticias:</u><br>
			- Requiere Discord Bot Maker <b>BETA</b>
		</p>
	</div><br>
Nombre:<br>
...
<div style="float: left; width: 50%;">
	Position:<br>
	<input id="position" class="round" type="text" placeholder="Dejalo en blanco y será por defecto!" style="width: 90%;"><br>
</div>
<div>
