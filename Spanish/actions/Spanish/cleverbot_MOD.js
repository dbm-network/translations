...
short_description: "Recopila respuestas automáticas de las APIs de cleverbot!",
	...
	<div style="width: 45%; padding-top: 8px;">
		API:<br>
			<select id="WhichAPI" class="round">
				<option value="0" selected>Cleverbot.io (Gratis)</option>
				<option value="1">Cleverbot.com (Trial Gratis)</option>
			</select>
	</div>
</div><br>
<div>
	...
	<div style="float: left; width: 80%; padding-top: 8px;">
	   Usuario API:<br>
	   <input id="APIuser" class="round" type="text" placeholder="Dejalo en blanco si usas cleverbot.com">
	</div><br>
	<div style="float: left; width: 80%; padding-top: 8px;">
	   API Key:<br>
	...
	<div id="comment" style="padding-top: 30px; padding-top: 8px;">
		<p>
		<u>¿Qué API debo utilizar?</u><br>
		Cleverbot.io es completamente gratuito. Sólo tiene que iniciar sesión con un correo electrónico para obtener una clave de API. Pero ese robot es un poco tonto. Te está haciendo las mismas preguntas en cada comienzo, etc.<br>
		Cleverbot.com es mucho más inteligente. Pero sólo es gratis para 5000 llamadas/preguntas. Si quieres más, tendrás que pagar (o crear una nueva cuenta).<br><br>
		Consigue la clave de cleverbot.io: https://cleverbot.io/keys<br>
		Obtenga la clave de cleverbot.com: http://www.cleverbot.com/api<br>
		Copie los enlaces en su navegador.<br>
		</p>
	</div>
</div>`
},
