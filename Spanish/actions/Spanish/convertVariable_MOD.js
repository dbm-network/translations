...
short_description: "Esto te ayudará a convertir a una variable Ej. En una String o Número(Int)",
long_description: "INFO (Qué es lo que hace):\nBásicamente, convierte su entrada o variable en un número o String.\nString son normalmente aquellos con \"\"/''/ `` \nLos números son los esperados como números pero sin estas \"\" cosas.\nEstos números se guardarán si la entrada era una palabra como \"NaN\" (Not available Now/ No disponible ahora) porque la entrada no era un número (Convertir: a número).\nLas strings se guardan principalmente como \"Hola\". Las strings no se ven afectadas por nada, por lo que la entrada será la misma que antes, pero si antes fuera un número, se convertirá en una cadena. Útil para convertir un json guardado de webapi que era un número antes.\nMás información acerca de las Strings en  Javascript(Lenguaje de programación.): ( https://www.w3schools.com/jsref/jsref_obj_string.asp ),\nMás información sobre Números(Int) en Javascript(Lenguaje de Programación.): ( https://www.w3schools.com/js/js_numbers.asp )",
	...
	<div>
		<div class="embed" style="width:98%;">
			<embedleftline></embedleftline><div class="embedinfo">
				<span class="embed-auth"><u>Mod Info</u><br>Creado por ${this.author}</span><br>
				<span class="embed-desc">${this.short_description}<br>Agregado en: ${this.version}</span>
			</div>
		</div>
	</div>
	<div style="width: 35%;">
		<div class="col-3 input-effect" style="width: 150%;">
            ...
            <label>Insertar variable Aquí</label>
