...
<div>
	<div style="float: left; width: 40%;">
		...
		<select id="info" class="round">
			<option value="0" selected>ID del Miembro</option>
			<option value="1">Nombre del Miembro</option>
			<option value="2">Nombre a mostrar del Miembro</option>
			<option value="3">Color del Miembro</option>
		</select>
	</div>
	<div style="float: right; width: 55%;">
		Valor de búsqueda:<br>
