...
subtitle: function(data) {
	const list = ['Serveri Liikmed', 'Serveri Kanalid', 'Serveri Rollid', 'Serveri Emojid', 'Kõik Roboti Serverid', 'Mainitud Kasutaja Roll', 'Käskluse Autori Roll', 'Ajutinje Muutuja', 'Serveri Muutuja', 'Globaalne Muutuja'];
	return `Teisenda ${list[parseInt(data.list)]} tekstiks`;
},
