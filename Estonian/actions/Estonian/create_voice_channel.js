...
variableStorage: function(data, varType) {
	...
	return ([data.varName, 'Häälekanal']);
},
...
<div style="float: left; width: 50%;">
	Bitikiirus:<br>
	<input id="bitrate" class="round" type="text" placeholder="Jäta tühjaks vaikimisi jaoks!" style="width: 90%;"><br>
</div>
<div style="float: right; width: 50%;">
	Kasutaja Piirang:<br>
	<input id="userLimit" class="round" type="text" placeholder="Jäta tühjaks vaikimisi jaokst!" style="width: 90%;"><br>
</div>
<div>
