...
subtitle: function(data) {
	const channels = ['Sama Kanal', 'Käskluse Autor', 'Mainitud Kasutaja', 'Mainitud Kanal', 'Vaikimisi Kanal', 'Ajutine Muutuja', 'Serveri Muutuja', 'Globaalne Muutuja'];
...
<div style="padding-top: 8px;">
	Sõnum:<br>
	<textarea id="message" rows="9" placeholder="Sisesta sõnum siia..." style="width: 99%; font-family: monospace; white-space: nowrap; resize: none;"></textarea>
</div><br>
<div>
	<div style="float: left; width: 35%;">
		Salvesta:<br>
