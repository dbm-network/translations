...
<div>
	<div style="float: left; width: 35%;">
		Osaks Saanud Objekti Allikas:<br>
...
<div style="padding-top: 8px;">
	Välja Kirjeldus:<br>
	<textarea id="message" rows="8" placeholder="Sisesta sõnum siia..." style="width: 99%; font-family: monospace; white-space: nowrap; resize: none;"></textarea>
</div>`
},
