...
subtitle: function(data) {
	const measurements = ['Millisekundid', 'Sekundid', 'Minutid', 'Tunnid'];
...
<div>
	<div style="float: left; width: 45%;">
		...
		<select id="measurement" class="round">
			<option value="0">Millisekundid</option>
			<option value="1" selected>Sekundid</option>
			<option value="2">Minutid</option>
			<option value="3">Tunnid</option>
		</select>
	</div>
