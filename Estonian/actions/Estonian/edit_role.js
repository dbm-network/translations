...
subtitle: function(data) {
	const roles = ['Mainitud Roll', 'Esimene Autori Roll', 'Esimene Serveri Roll', 'Ajutine Muutuja', 'Serveri Muutuja', 'Globaalne Muutuja'];
...
<div style="float: left; width: 50%;">
	Kuva Eraldi Onlain Kasutajatest:<br>
	<select id="hoist" class="round" style="width: 90%;">
		<option value="none" selected>Ära Muuda</option>
...
<div style="float: right; width: 50%;">
	Värv:<br>
	<input id="color" class="round" type="text" placeholder="Jäta tühjaks, et mitte muuta!"><br>
	Positsioon:<br>
	<input id="position" class="round" type="text" placeholder="Jäta tühjaks, et mitte muuta!" style="width: 90%;"><br>
</div>`
},
