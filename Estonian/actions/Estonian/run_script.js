...
variableStorage: function(data, varType) {
	...
	return ([data.varName, 'Teadmatu Tüüp']);
},
...
<div>
	<div style="float: left; width: 45%;">
		...
		<select id="behavior" class="round">
			<option value="0" selected>Kutsu Järgmist Toimingut Automaatselt</option>
			<option value="1">Ära Kutsu Järgmist Toimingut</option>
		</select>
	</div>
	<div style="padding-left: 5%; float: left; width: 55%;">
		Interpretation Style:<br>
		<select id="interpretation" class="round">
			<option value="0" selected>Hinda Teksti Esimesena</option>
			<option value="1">Hinda Teksti Otseselt</option>
		</select>
	</div>
</div><br><br><br>
