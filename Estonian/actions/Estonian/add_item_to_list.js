...
subtitle: function(data) {
	const storage = ['', 'Ajutine Muutuja', 'Serveri Muutuja', 'Globaalne Muutuja'];
	return `Lisa "${data.value}" ${storage[parseInt(data.storage)]} (${data.varName})`;
},
...
<div style="padding-top: 8px;">
	<div style="float: left; width: 45%;">
		...
		<select id="addType" class="round" onchange="glob.onChange1(this)">
			<option value="0" selected>Lisa Lõppu</option>
			<option value="1">Lisa Ette</option>
			<option value="2">Lisa Kindlasse Positsiooni</option>
		</select>
	</div>
