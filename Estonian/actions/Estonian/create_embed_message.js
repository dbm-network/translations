...
variableStorage: function(data, varType) {
	...
	return ([data.varName, 'Osaks Saanud Sõnum']);
},
...
<div style="float: left; width: 50%;">
	...
	Autor:<br>
	<input id="author" class="round" type="text" placeholder="Jäta tühjaks, et keelata autorit!"><br>
	Värv:<br>
	<input id="color" class="round" type="text" placeholder="Jäta tühjaks vaikimisi jaoks!"><br>
	Kasuta Ajatemplit:<br>
...
<div style="float: right; width: 50%;">
	URL:<br>
	<input id="url" class="round" type="text" placeholder="Jäta tühjaks mitte ühekski!"><br>
	Autori Ikooni URL:<br>
	<input id="authorIcon" class="round" type="text" placeholder="Jäta tühjaks mitte ühekski!"><br>
	Pildi URL:<br>
	<input id="imageUrl" class="round" type="text" placeholder="Jäta tühjaks mitte ühekski!"><br>
	Pisipildi URL:<br>
	<input id="thumbUrl" class="round" type="text" placeholder="Jäta tühjaks mitte ühekski!"><br>
</div>
<div>
