...
subtitle: function(data) {
	const names = ['Käskluse Sõnum', 'Ajutine Muutuja', 'Serveri Muutuja', 'Globaalne Muutuja'];
	const index = parseInt(data.storage);
	return data.storage === "0" ? `Lisa Reaktsioon ${names[index]}` : `Lisa Reaktsioon ${names[index]} (${data.varName})`;
},
...
<div style="padding-top: 8px;">
	<div style="float: left; width: 35%;">
		...
		<select id="emoji" name="second-list" class="round" onchange="glob.onChange1(this)">
			<option value="4" selected>Otsene Emoji</option>
			<option value="0">Kohandatud Emoji</option>
			<option value="1">Ajutine Muutuja</option>
			<option value="2">Serveri Muutuja</option>
			<option value="3">Globaalne Muutuja</option>
		</select>
	</div>
	<div id="varNameContainer2" style="float: right; width: 60%;">
		<span id="extName">Emoji  (parem-klõps -> Sisesta Emoji)</span>:<br>
