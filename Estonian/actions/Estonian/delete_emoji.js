...
subtitle: function(data) {
	const inputTypes = ['Kindel Emoji', 'Ajutine Muutuja', 'Serveri Muutuja', 'Globaalne Muutuja'];
...
<div>
	<div style="float: left; width: 35%;">
		...
		<select id="emoji" class="round" onchange="glob.onChange1(this)">
			<option value="0" selected>Kindel Emoji</option>
	...
	<div id="varNameContainer" style="float: right; width: 60%;">
		<span id="extName">Emoji Nimi</span>:<br>
