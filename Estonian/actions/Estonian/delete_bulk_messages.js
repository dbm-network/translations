...
subtitle: function(data) {
	const channels = ['Sama Kanal', 'Mainitud Kanal', 'Esimene Serveri Kanal', 'Ajutine Muutuja', 'Serveri Muutuja', 'Globaalne Muutuja'];
	return `Kustuta ${data.count} sõnumid ${channels[parseInt(data.channel)] || 'Mitte midagi'}`;
},
...
<div>
	<div style="float: left; width: 35%;">
		...
		<select id="condition" class="round" onchange="glob.onChange2(this)">
			<option value="0" selected>Mitte Ükski</option>
			<option value="1">Omab Autorit</option>
			<option value="2">Kohandatud</option>
		</select>
	</div>
