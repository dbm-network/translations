...
subtitle: function(data) {
	return `Kutsu Käsklust/Sündmust ID "${data.source}"`;
},
...
<div style="width: 85%;">
	...
	<select id="source" class="round">
		<optgroup id="commands" label="Käsklused"></optgroup>
		<optgroup id="events" label="Sündmused"></optgroup>
	</select><br>
	Call Type:<br>
	<select id="type" class="round">
		<option value="true" selected>Sünkroonne</option>
		<option value="false">Asünkroonne</option>
	</select>
</div>`
},
