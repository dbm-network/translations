...
<div>
	<div style="float: left; width: 45%;">
		...
		<select id="condition" class="round">
			<option value="0" selected>Parameetrite Arv on...</option>
			<option value="1">Mainitud Liikmete Arv on...</option>
			<option value="2">Mainitud Kanalite Arv on...</option>
			<option value="3">Mainitud Rollide Arv on...</option>
		</select>
	</div>
