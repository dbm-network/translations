...
<div style="padding-top: 8px; width: 80%;">
		Muutuja Tüüp, mida Kontrollida:<br>
		<select id="comparison" class="round">
			<option value="0" selected>Arv</option>
			<option value="1">Rida</option>
			<option value="2">Pilt</option>
			<option value="3">Liige</option>
			<option value="4">Sõnum</option>
			<option value="5">Tekstikanal</option>
			<option value="6">Häälekanal</option>
