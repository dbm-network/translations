...
subtitle: function(data) {
	const storeTypes = ["", "Ajutine Muutuja", "Serveri Muutuja", "Globaalne Muutuja"];
...
<div style="padding-top: 8px; width: 45%">
	...
	<select id="mask" class="round">
		<option value="0" selected>Pealiskiht</option>
		<option value="1">Asendama</option>
		<option value="2">Varjama/option>
	</select>
</div>`
},
