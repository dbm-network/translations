...
subtitle: function(data) {
	const storeTypes = ["", "Zmienna tymczasowa", "Zmienna serwerowa", "Zmienna globalna"];
	const mirror = ["Brak odbicia lustrzanego", "Odbicie lustrzane poziome", "Odbicie lustrzane pionowe", "Odbicie lustrzane na ukos"];
...
<div style="padding-top: 8px;">
	<div style="float: left; width: 45%;">
		...
		<select id="mirror" class="round">
			...
			<option value="1">Odbicie lustrzane poziome</option>
			<option value="2">Odbicie lustrzane pionowe</option>
			<option value="3">Odbicie lustrzane na ukos</option>
		</select><br>
	</div>
	<div style="float: right; width: 50%;">
		Obrót (w stopniach):<br>
