...
subtitle: function(data) {
	const info = ['ID serwera', 'nazwie serwera', 'skrócie nazwy serwera', 'liczbie członków serwera', 'regionie serwera', 'ID właściciela serwera', 'poziomie weryfikacji serwera', 'dostępności serwera'];
	return `Szukaj serwera po ${info[parseInt(data.info)]}`;
},
...
<div>
	<div style="float: left; width: 40%;">
		...
		<select id="info" class="round">
			<option value="0" selected>ID serwera</option>
			<option value="1">Nazwa serwera</option>
			<option value="2">Skrócona nazwa serwera</option>
			<option value="3">Liczba członków serwera</option>
			<option value="4">Region serwera</option>
			<option value="5">ID właściciela serwera</option>
			<option value="6">Poziom weryfikacji</option>
			<option value="7">Serwer jest dostępny</option>
		</select>
	</div>
