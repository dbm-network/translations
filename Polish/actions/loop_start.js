...
subtitle: function(data) {
	...
	return `Rozpocznij pętlę ${storage[parseInt(data.storage)]} (${data.varName2})`;
},
...
<div>
	<div style="float: left; width: 94%;">
		...
		<select id="loop" class="round">
			<option value="0" selected>Pętla od początku</option>
			<option value="1">Pętla od końca</option>
		</select>
	</div>
</div><br><br><br>
<div>
