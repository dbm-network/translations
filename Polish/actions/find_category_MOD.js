...
subtitle: function(data) {
	const info = ['ID', 'nazwie', 'temacie'];
	return `Znajdź kategorię po jej ${info[parseInt(data.info)]}`;
},
...
html: function(isEvent, data) {
	...
	<p>
		...
		Stworzony przez NetLuis!<br>
		Na pomysł SAFAxSNIPER
	</p>
</div><br>
<div>
	<div style="float: left; width: 40%;">
		...
		<select id="info" class="round">
			<option value="0" selected>ID kategorii</option>
...
<p>Możesz edytować kategorię za pomocą akcji „Informacje o kanale”, „Edytuj kanał” lub „Ustaw uprawnienia kanału”.</p>
