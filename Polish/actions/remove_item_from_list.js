...
subtitle: function(data) {
	...
	return `Usuń pozycję z listy ${storage[parseInt(data.storage)]} (${data.varName})`;
},
...
<div style="padding-top: 8px;">
	<div style="float: left; width: 45%;">
		...
		<select id="removeType" class="round" onchange="glob.onChange1(this)">
			<option value="0" selected>Usuń od końca</option>
			<option value="1">Usuń od początku</option>
			<option value="2">Usuń z określonej pozycji</option>
		</select>
	</div>
