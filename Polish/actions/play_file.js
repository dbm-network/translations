...
<div style="float: right; width: 50%;">
	Głośność (0 = min; 100 = max):<br>
	<input id="volume" class="round" type="text" placeholder="Zostaw puste jeśli automatyczne..."><br>
	Bitrate:<br>
	<input id="bitrate" class="round" type="text" placeholder="Zostaw puste jeśli automatyczne...">
</div><br><br><br><br><br><br><br>
<div>
	Typ odtwarzania<br>
	<select id="type" class="round" style="width: 90%;">
		<option value="0" selected>Dodaj do kolejki</option>
		<option value="1">Graj natychmiast</option>
	</select>
</div>`
},
