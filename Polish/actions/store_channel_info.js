...
subtitle: function(data) {
	const channels = ['Ten sam kanał', 'Wspomniany kanał', '1szy kanał na serwerze', 'Zmienna tymczasowa', 'Zmienna serwerowa', 'Zmienna globalna'];
	const info = ['Kanał jako objekt', 'ID kanału', 'Nazwa kanału', 'Temat kanału', 'Ostatnia wiadomość na tym kanale', 'Pozycja kanału', 'Czy kanał jest NSFW?', 'Kanał jest kanałem do wiadomości bezpośrednich?', 'Kanał można usunąć??', 'Data utworzenia kanału', 'Nazwa kategorii, w której znajduje się kanał'];
...
<div>
	<div style="padding-top: 8px; width: 70%;">
		...
		<select id="info" class="round">
			<option value="0" selected>Kanał jako objekt</option>
			<option value="1">ID kanału</option>
			<option value="2">Nazwa kanału</option>
			<option value="3">Temat kanału</option>
			<option value="4">Ostatnia wiadomość na tym kanale</option>
			<option value="5">Pozycja kanału</option>
			<option value="6">Kanał jest NSFW?</option>
			<option value="7">Kanał jest kanałem do wiadomości bezpośrednich?</option>
			<option value="8">Kanał można usunąć?</option>
			<option value="9">Data utworzenia kanału</option>
			<option value="10">Nazwa kategorii, w której znajduje się kanał</option>
		</select>
	</div>
</div><br>
<div>
	<div style="float: left; width: 35%;">
		Przedstaw zmienną jako:<br>
