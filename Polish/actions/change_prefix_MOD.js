...
<div>
	<p>
		...
		Stworzony przez EliteArtz<br>
	</p>
    <p>
        <u>Dziękuję:</u><br>
        General Wrex za pomoc w pisaniu skryptu<br>
    </p>
    Zmień prefix:<br>
...
action: function (cache) {
    ...
    try {
        ...
        if (prefix) {
            ...
            this.getDBM().Files.saveData("settings", function () { console.log("Prefix został zmieniony: " + prefix) });
        } else {
            console.log(prefix + " jest niepoprawny! Spróbuj ponownie!");
        }
    } catch (err) {
        console.log("BŁĄD!" + err.stack ? err.stack : err);
    }
