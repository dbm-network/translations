...
name: "Ustaw uprawnienia kanału głosowego",
...
subtitle: function(data) {
    const names = ['Kanał głosowy na którym znajduje się autor komendy', 'Kanał głosowy na którym znajduje się wspomniany użytkownik', 'Domyślny kanał głosowy', 'Zmienna tymczasowa', 'Zmienna serwerowa', 'Zmienna globalna'];
	...
	<div>
	  <p>
		  <u>Informacje o modzie:</u><br>
			Stworzony przez EliteArtz
		</p>
	</div><br>
<div>
	<div style="float: left; width: 45%;">
		Źródło - kanał głosowy:<br>
...
<div style="padding-top: 8px;">
	...
	<div style="padding-left: 5%; float: left; width: 55%;">
		...
		<select id="state" class="round">
			<option value="0" selected>Zezwalaj</option>
			<option value="1">Odmów</option>
		</select>
	</div>
</div>`
},
