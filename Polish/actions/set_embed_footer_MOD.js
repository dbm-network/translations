...
<div style="padding-top: 8px;">
	Stopka:<br>
	<textarea id="message" rows="3" placeholder="Tutaj wpisz treść stopki..." style="width: 93.6%; font-family: monospace; white-space: nowrap; resize: none;"></textarea>
</div><br>
<div style="float: left; width: 104.1%;">
	Adres internetowy miniatury stopki:<br>
	<input id="footerIcon" class="round" type="text" placeholder="Zostaw puste jeśli brak!"><br>
</div>`
},
