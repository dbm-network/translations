...
name: "Informacje o parametrach wiadomości",
...
subtitle: function(data) {
	...
	const info = ['Jeden parametr', 'Wiele parametrów', 'Wspomniany użytkownik', 'Wspomniany członek', 'Wspomniana rola', 'Wspomniany kanał']
...
<div style="padding-top: 8px;">
    <div style="float: left; width: 35%;">
    	...
    	<select id="info" class="round" onchange="glob.onChange1(this)">
            ...
            <option value="2">Wspomniany użytkownik</option>
		    <option value="3">Wspomniany członek</option>
		    <option value="4">Wspomniana rola</option>
		    <option value="5">Wspomniany kanał</option>
        </select>
    </div>
	<div style="float: right; width: 60%;">
	    <span id="infoCountLabel">Numer parametru:</span><br>
	    <input id="ParamN" class="round" type="text" value="1">
    </div>
</div><br><br><br>
<div id="DiVseparator" style="padding-top: 8px;">
    <div style="float: left; width: 567px;">
	    Niestandardowy separator parametru:<br>
	    <input id="separator" placeholder="Przeczytaj uwagę poniżej | Domyślny separator parametru" class="round" type="text">
    </div>
<br><br><br></div>
<div style="padding-top: 8px;">
	<div style="float: left; width: 35%;">
...
<div style="float: left; width: 88%; padding-top: 8px;">
        <p>
        <b><span style="color:#ffffff; font-size: 20px;">Notka:</span></b><br>
        Pozostaw puste pole, jeśli chcesz użyć ustawień z zakładki "Ustawienia"<br>
        </p>
