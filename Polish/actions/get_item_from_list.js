...
subtitle: function(data) {
	const list = ['członków serwera', 'kanałów serwera', 'ról serwera', 'emoji serwera', 'wszystkich botów na serwerze', 'ról wspomnianego członka', 'ról autora komendy', 'Zmienna tymczasowa', 'Zmienna serwerowa', 'Zmienna globalna'];
	return `Uzyskaj pozycję z listy ${list[parseInt(data.list)]}`;
},
...
<div style="padding-top: 8px;">
	<div style="float: left; width: 45%;">
		Pozycja do przechowania:<br>
		<select id="getType" class="round" onchange="glob.onChange1(this)">
			<option value="0" selected>Pierwsza pozycja</option>
			<option value="1">Ostatnia pozycja</option>
			<option value="2">Losowa pozycja</option>
			<option value="3">Pozycja określona</option>
		</select>
	</div>
