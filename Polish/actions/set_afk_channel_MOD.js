...
subtitle: function(data) {
	const channels = ['Kanał głosowy na którym znajduje się autor komendy', 'Kanał głosowy na którym znajduje się wspomniany użytkownik', 'Domyślny kanał głosowy', 'Zmienna tymczasowa', 'Zmienna serwerowa', 'Zmienna globalna'];
	...
	short_description:  "Ustawia kanał AFK serwera.",
