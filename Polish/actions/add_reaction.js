...
subtitle: function(data) {
	const names = ['wiadomości - komendy', 'zmiennej tymczasowej', 'zmiennej serwerowej', 'zmiennej globalnej'];
	const index = parseInt(data.storage);
	return data.storage === "0" ? `Dodaj reakcję do ${names[index]}` : `Dodaj reakcję do ${names[index]} (${data.varName})`;
},
...
<div style="padding-top: 8px;">
	<div style="float: left; width: 35%;">
		...
		<select id="emoji" name="second-list" class="round" onchange="glob.onChange1(this)">
			<option value="4" selected>Bezpośrednia emotka</option>
			<option value="0">Niestand. emotka</option>
			<option value="1">Zmienna tymczasowa</option>
			<option value="2">Zmienna serwerowa</option>
			<option value="3">Zmienna globalna</option>
		</select>
	</div>
	<div id="varNameContainer2" style="float: right; width: 60%;">
		<span id="extName">Emoji (kliknij prawym -> wybierz emoji)</span>:<br>
