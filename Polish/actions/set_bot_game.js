...
<div style="width: 90%;">
	Link do transmisji na żywo z serwisu Twitch:<br>
	<input id="gameLink" class="round" type="text" placeholder="Zostaw puste jeśli zabronione!">
</div>
`
},
