module.exports = {
	...
	name: "Informacje o serwerze gier",
	...
	subtitle: function (data) {
		const info = ['Nazwa serwera', 'Mapa', 'Liczba graczy', 'Liczba botów', 'Maksymalna liczba graczy', 'Tagi serwera', 'Czy serwer jest zabezpieczony hasłem?'];
	...
	html: function (isEvent, data) {
		...
		<div class="embed">
        	...
        	<div class="embedinfo">
	    	<span class="embed-auth"><u>Mod Info:</u><br>Stworzony przez <b>${this.author}</b></span><br>
	    	<span class="embed-desc">${this.short_description}<br>Wersja: ${this.version}</span>
        </div>
        </div><br>
		...
		<div style="float: left; width: 50%; padding-left: 10px; padding-top: 8px;">
		 	Port serwera:<br>
		 	<textarea id="serverport" rows="2" placeholder="Zostaw puste, jeśli chcesz zastosować ust. domyślne" style="width: 90%; font-family: monospace; white-space: nowrap; resize: none;"></textarea>
	  	</div>
	...
	<div style="float: left; width: 55%; padding-top: 8px;">
		...
		<select id="info" class="round">
			<option value="0" selected>Nazwa serwera</option>
			<option value="1">Mapa</option>
			<option value="2">Liczba graczy na serwerze</option>
			<option value="3">Liczba botów na serwerze</option>
			<option value="4">Maksymalna liczba graczy</option>
			<option value="5">Tagi serwera</option>
			<option value="6">Czy serwer jest zabezpieczony hasłem?</option>
			</select>
			</div>
