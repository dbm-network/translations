module.exports = {
	...
	subtitle: function(data) {
		const names = ['Ten sam kanał', 'Wspomniany kanał', 'Kanał domyślny', 'Zmienna tymczasowa', 'Zmienna serwerowa', 'Zmienna globalna'];
		const opt = ['Name', 'Temat kanału', 'Pozycja', 'Bitrate', 'Limit użytkowników', 'ID kategorii', 'Rate Limit Per User'];
	...
	html: function(isEvent, data) {
		...
		<div>
			<p>
				...
				Stworzony przez Lasse, MrGold & NetLuis!
			</p>
		</div><br>
	<div>
	...
	<div>
		<div style="float: left; width: 35%;">
			...
			<select id="toChange" class="round">
				<option value="0" selected>Nazwa</option>
				<option value="1">Temat kanału</option>
				<option value="2">Pozycja</option>
