...
subtitle: function(data) {
	const info = ['Zastąp pierwszy wynik', 'Zastąp wszystkie wyniki']
...
<div style="padding-top: 8px;">
		...
		Stworzony przez <b>iAmaury</b> & <b>EliteArtz</b>!</p>
</div><br>
<div style="padding-top: 8px;">
	Źródło - tekst:
	<textarea id="text" rows="3" placeholder="Wstaw tutaj tekst..." style="width: 99%; font-family: monospace; white-space: nowrap; resize: none;"></textarea>
</div>
<div>
...
<select id="info" class="round">
	<option value="0" selected>Zastąp pierwszy wynik</option>
	<option value="1">Zastąp wszystkie wyniki</option>
</select>
</div><br>
<div style="padding-top: 8px;">
