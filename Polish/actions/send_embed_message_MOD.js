module.exports = {
    ...
    name: "Wyślij wiadmość Embed MOD",
    ...
    subtitle: function(data) {
        const channels = ['Ten sam kanał', 'Autor komendy', 'Wspomniany użytkownik', 'Wspomniany kanał', 'Kanał domyślny', 'Zmienna tymczasowa', 'Zmienna serwerowa', 'Zmienna globalna']
    ...
    <div>
        ...
        <div style="float: left; padding-top: 4px; width: 42%; height: 30px">
            Treść wiadomości:<br>
            <input id="messageContent" class="round" type="text" placeholder="Zostawpuste, aby zignorować...">
        </div><br><br><br>
