...
<div style="padding-top: 8px;">
	<div style="float: left; width: 50%;">
		Nazwa pola:<br>
		<input id="fieldName" placeholder="Opcjonalne" class="round" type="text">
	</div>
	<div style="float: left; width: 50%;">
		Wyświetl w linii:<br>
...
<div style="padding-top: 8px;">
	Opis pola:<br>
	<textarea id="message" rows="7.5" placeholder="Tutaj wstaw wiadomość... (Opcjonalne)" style="width: 99%; font-family: monospace; white-space: nowrap; resize: none;"></textarea>
</div>`
},
