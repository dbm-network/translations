...
<div>
	<div>
		<p>Mod stworzony przez ${this.author}.</p>
	</div>
...
<div style="padding-top: 20px;">
	<div style="float: left; width: 35%;">
		...
		<select id="info" class="round">
			...
			<option value="2">Można go wyrzucić?</option>
			<option value="1">Można go zbanować?</option>
			<option value="5">Jest zarządzalny przez użytkownika?</option>
			<!-- option value="3">Jest mówiący?</option --!>
			<option value="7">Jest wyciszony?</option>
			<option value="8">Ma wyłączony dźwięk na serwerze?</option>
