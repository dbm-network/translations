...
subtitle: function(data) {
	const info = ['po ID roli', 'po nazwie roli', 'po kolorze roli'];
	return `Wyszukaj rolę ${info[parseInt(data.info)]}`;
},
...
<div>
	<div style="float: left; width: 40%;">
		...
		<select id="info" class="round">
			<option value="0" selected>ID roli</option>
			<option value="1">Nazwa roli</option>
			<option value="2">Kolor roli</option>
		</select>
	</div>
