...
ID kategorii:<br>
<input id= "categoryID" class="round" type="text" placeholder="Zostaw puste, jeśli nie chcesz przypisywać do kategorii" style="width: 95%"><br>

<div style="float: left; width: 50%;">
	Bitrate:<br>
	<input id="bitrate" class="round" type="text" placeholder="Zostaw puste jeśli domyślne!" style="width: 90%;"><br>
</div>

<div style="float: right; width: 50%;">
	Limit użytkowników:<br>
	<input id="userLimit" class="round" type="text" placeholder="Zostaw puste jeśli domyślne!" style="width: 90%;"><br>
</div>
