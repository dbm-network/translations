...
ID kategorii:<br>
<input id= "categoryID" class="round" type="text" placeholder="Pozostaw puste, jeśli nie chcesz umieszczać go w kategorii" style="width: 95%"><br>
...
<div style="float: right; width: 50%;">
	Pozycja:<br>
	<input id="position" class="round" type="text" placeholder="Zostaw puste dla domyślnego!" style="width: 90%;"><br>
</div>
