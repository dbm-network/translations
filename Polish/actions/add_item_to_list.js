...
subtitle: function(data) {
	...
	return `Dodaj "${data.value}" do ${storage[parseInt(data.storage)]} (${data.varName})`;
},
...
<div style="padding-top: 8px;">
	<div style="float: left; width: 45%;">
		Typ dodania pozycji do listy:<br>
		<select id="addType" class="round" onchange="glob.onChange1(this)">
			<option value="0" selected>Dodaj na koniec</option>
			<option value="1">Dodaj na początek</option>
			<option value="2">Dodaj do określonej pozycji</option>
		</select>
	</div>
