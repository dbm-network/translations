...
<div style="padding-top: 8px; width: 80%;">
		Typ zmiennej do sprawdzenia:<br>
		<select id="comparison" class="round">
			<option value="0" selected>Numer</option>
			<option value="1">Ciąg znaków | String</option>
			<option value="2">Obraz</option>
			<option value="3">Członek</option>
			<option value="4">Wiadomość</option>
			<option value="5">Kanał tekstowy</option>
			<option value="6">Kanał głosowy</option>
			<option value="7">Rola</option>
			<option value="8">Serwer</option>
