module.exports = {
	...
	subtitle: function (data) {
		if (data.info === "downloadspeed") {
			return "Prędkość pobierania - Download"
		} else if (data.info === "uploadspeed") {
			return "Prędkość wysyłania - Upload"
		} else {
	...
	short_description:  "Testuje i zapisuje prędkość pobierania/wysyłania.",
	...
	variableStorage: function (data, varType) {
		...
		let dataType;
		if (data.info === 'downloadspeed') {
			dataType = 'Prędkość pobierania - Download'
		} else if (data.info === 'uploadspeed') {
			dataType = 'Prędkość wysyłania - Upload'
		} else {
			dataType = 'Nieznany typ'
		}
	...
	html: function (isEvent, data) {
        ...
        <div class="embedinfo">
	    <span class="embed-auth"><u>Informacje o modzie:</u><br>Stworzony przez <b>${this.author}</b></span><br>
	...
	<div style="float: left; width: 50%; padding-top: 8px;">
		...
		<select id="info" class="round">
			<option value="downloadspeed" selected>Prędkość pobierania - Download</option>
			<option value="uploadspeed">Prędkość wysyłania - Upload</option>
		</select>
	</div>
