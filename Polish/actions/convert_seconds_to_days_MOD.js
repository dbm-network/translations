...
html: function(isEvent, data) {
	...
	<div style="float: left; width: 95%; padding-top: 8px;">
		...
		Stworzony przez <b>Aamon</b>! <br> Konwertuj sekundy na dni, minuty oraz sekundy.</p>
	</div>
	<br><br><br>
	<div style="float: left; width: 70%; padding-top: 8px;">
		Sekundy do konwersji:
		<input id="time" class="round" type="text" placeholder="np. 1522672056 lub użyj zmiennej">
	</div>
	...
	<div style=" float: left; width: 88%; padding-top: 8px;">
		<br>
		<p>
			W celu uzyskania dodatkowych informacji proszę o kontakt <b>Aamon#9130</b> na Discordzie lub <a href ="https://twitter.com/44m0n"><b>@44m0n<b></a> na Twitterze. 
		</p>
	</div>`;
},
