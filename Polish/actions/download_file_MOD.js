...
<div>
    <p>
		...
		Stworzony przez MrGold<br>
		<span style="opacity:0.5">("Save Image" stworzony przez Aamon został zawarty w tym modzie)</span>
    </p>
</div><br>
...
<p>
  ...
  Ścieżka pliku, "./" ukazuje ścieżkę do folderu projektu bota.<br>
  Nazwa pliku i format pliku są przydzielane automatyczne, ale możesz je zmienić.
</p>
`
},
