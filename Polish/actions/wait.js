...
subtitle: function(data) {
	const measurements = ['milisekund(-y)', 'sekund(-y)', 'minut(-y)', 'godzin(-y)'];
...
<div>
	<div style="float: left; width: 45%;">
		...
		<select id="measurement" class="round">
			<option value="0">Milisekundy</option>
			<option value="1" selected>Sekundy</option>
			<option value="2">Minuty</option>
			<option value="3">Godziny</option>
		</select>
	</div>
