...
<div>
	...
	Stworzony przez MrGold<br> Naprawiony przez NetLuis<br> 
	Zmodyfikowany przez ZockerNico</p>
</div><br>
<div style="float: left; width: 105%;">
	Twój główny plik bota:<br>
	<input id="filename" class="round" type="text" value="bot.js"><br>
</div>
<div><br>
	<p><u>Uwaga!</u><br>
		Żadna akcja poniżej tej akcji nie zostanie wykonana!</p>
</div>`
},
