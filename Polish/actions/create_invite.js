...
<div style="padding-top: 8px;">
	<div style="float: left; width: 70%;">
		Maks. liczba użyć:<br>
		<input id="maxUses" class="round" type="text" placeholder="Zostaw puste jeśli bez ograniczeń!"><br>
		Czas na użycie (w sekundach):<br>
		<input id="lifetime" class="round" type="text" placeholder="Zostaw puste jeśli zapr. perm.!"><br>
	</div>
