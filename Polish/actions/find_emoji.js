...
name: "Znajdź niestandardową emoji",
...
subtitle: function(data) {
	const info = ['ID', 'nazwie'];
	return `Szukaj emoji po jej ${info[parseInt(data.info)]}`;
},
...
<div>
	<div style="float: left; width: 40%;">
		...
		<select id="info" class="round">
			<option value="0" selected>ID emoji</option>
			<option value="1">Nazwa emoji</option>
		</select>
	</div>
