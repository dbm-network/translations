module.exports = {
	...
	subtitle: function (data) {
		return `Tłumacz [${data.translateTo}]`;
	},
...
<div>
	...
	<div style="float: right; width: 60%;">
		Przetłumacz na:<br>
		<input id="translateTo" placeholder="Powinny być tutaj 2 litery." class="round" type="text" maxlength="2"><br>
	</div>
</div><br><br><br>
<div style="padding-top: 8px;">
	Przetłumacz wiadomość:<br>
	<textarea id="translateMessage" rows="9" placeholder="Wstaw tutaj wiadomość, którą chcesz przetłumaczyć..." style="width: 99%; font-family: monospace; white-space: nowrap; resize: none;"></textarea>
</div><br>
<div>
	...
	action: function (cache) {
		...
		if (!translateMessage) return console.log("Musisz napisać co chcesz przetłumaczyć.");
