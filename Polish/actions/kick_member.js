...
subtitle: function(data) {
	const members = ['Oznaczony użytkownik', 'Autor komendy', 'Zmienna tymczasowa', 'Zmienna serwerowa', 'Zmienna globalna'];
...
<div style="padding-top: 8px;">
	Powód:<br>
	<textarea id="reason" rows="5" placeholder="Tutaj wstaw powód..." style="width: 99%; font-family: monospace; white-space: nowrap; resize: none;"></textarea>
</div>`
},
