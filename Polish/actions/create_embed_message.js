...
<div>
	<p>
		Ta akcja została zmodyfikowana przez DBM Mods.
	</p>
</div>
<div style="float: left; width: 50%; padding-top: 16px;">
	...
	Nazwa autora:<br>
	<input id="author" class="round" type="text" placeholder="Pozostaw puste jeśli nie wprowadzasz!"><br>
	Adres internetowy autora:<br>
	<input id="authorUrl" class="round" type="text" placeholder="Pozostaw puste jeśli brak!"><br>
	Odnośnik do miniatury autora:<br>
	<input id="authorIcon" class="round" type="text" placeholder="Pozostaw puste jeśli brak!"><br>
</div>
<div style="float: right; width: 50%; padding-top: 16px;">
	Kolor:<br>
	<input id="color" class="round" type="text" placeholder="Pozostaw puste jeśli domyślne!"><br>
	Adres internetowy (URL):<br>
	<input id="url" class="round" type="text" placeholder="Pozostaw puste jeśli brak!"><br>
	Odnośnik do grafiki:<br>
	<input id="imageUrl" class="round" type="text" placeholder="Pozostaw puste jeśli brak!"><br>
	Odnośnik do miniatury:<br>
	<input id="thumbUrl" class="round" type="text" placeholder="Pozostaw puste jeśli brak!"><br>
</div>
<div id="timestampDiv" style="float: left; width: 45%; display: none;">
	Znacznik czasu:<br>
	<select id="timestamp" class="round" onchange="glob.onChange1(this)">
		<option value="false" selected>Brak znacznika czasu</option>
		<option value="true">Aktualny znacznik czasu</option>
		<option value="string">Znacznik czasu ciągu UTC</option>
		<option value="custom">Niestandardowy znacznik czasu</option>
	</select>
</div>
<div id="timestampDivDebug" style="float: left; width: 45%; display: none;">
	...
	<select id="timestampDebug" class="round" onchange="glob.onChange1(this)">
		<option value="false" selected>Nie pokazuj</option>
		<option value="true">Aktualny znacznik czasu</option>
	</select>
</div>
<div style="float: right; width: 50%; padding-right: 26px;">
	...
	<select id="debug" class="round" onchange="glob.onChange2(this)">
		<option value="false" selected>Nie - Więcej opcji</option>
		<option value="true">Tak - Bardziej stabilnie</option>
	</select>
</div>
<div id="timestamp1" class="round" style="float: left; width: 104.6%; padding-top: 16px; display: none;">
	Znacznik czasu UTC:<br>
	<input id="text" class="round" type="text" placeholder="Wstaw ciąg sygnatury czasowej utc...">
</div>
...
<div id="note1" style="float: left; padding-top: 8px; width: 100%; display: none;">
	...
	<p>
		To ustawienie działa z takimi formatami czasu jak "March 03, 1973 11:13:00" lub "100000000000" (milliseconds).<br>
	</p>
</div>
<div id="note2" style="float: left; padding-top: 8px; width: 100%; display: none;">
	<h2>
		Niestandardowy znacznik czasu<br>
	</h2>
	<p>
		Poprawne wprowadzenie:<br>
		Rok: [2019] Miesiąc: [8] Dzień: [10] Godzina: [ ] Minuta: [ ] Sekunda: [ ]<br>
		Niepoprawne wprowadzenie:<br>
		Rok: [2019] Miesiąc: [8] Dzień: [ ] Godzina: [6] Minuta: [ ] Sekunda: [ ]<br>
	</p>
</div>
</div>`
},
...
init: function() {
	...
	glob.onChange1 = function() {
		if(debug.value == "false") {
			authorUrl.placeholder = 'Pozostaw puste jeśli brak!';
	...
	glob.onChange2 = function() {
		switch(debug.value) {
			...
			case "true":
				...
				note.style.display = 'none';
				note2.style.display = 'none';
				authorUrl.placeholder = 'Niedostępne!';
				break;
		};
		glob.onChange1();
	};
