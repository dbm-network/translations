...
<div style="padding-top: 8px;">
	Wiadomosć: <div style="float:right"><u>Informacje o modzie:</u> Stworzony przez EGGSY</div><br>
	<textarea id="message" rows="6" placeholder="Tutaj wstaw wiadomosć..." style="width: 99%; font-family: monospace; white-space: nowrap; resize: none;"></textarea>
</div><br>
