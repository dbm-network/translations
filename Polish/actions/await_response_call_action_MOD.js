...
subtitle: function(data) {
	return `Czekaj na ${data.max} ${data.max === "1" ? `wiadomość` : `wiadomości`} w okresie ${data.time} ${data.time === "1" ? `milisekund` : `milisekund`}`;
},
...
html: function(isEvent, data) {
	...
	<p>
		...
		Stworzony przez MrGold, General Wrex oraz EliteArtz
	</p>
</div><br>
<div class="codeblock" style="float: left; width: 88%; padding-top: 8px;">
	<p>
	<span style="color:white"><b>Przykłady:</b><br><span style="color:#9b9b9b">
	content.equals('Akceptuje')<br>
	content.includes('wiadomosc zawiera')<br>
	content.startsWith('Hello')<br>
	content.endsWith('bye')<br>
	content.match(/response/)<br>
	<u><span class="wrexlink" data-url="https://www.w3schools.com/Jsref/jsref_obj_string.asp">Odwołanie do ciągu JavaScript</span></u><br>
	<br>
	author.id === '1234567890'<br>
	author.name === 'Mr.Gold'<br>
	author.tag === 'Mr.Gold#9003'<br>
	<br>
	<u><span class="wrexlink2" data-url2="https://www.w3schools.com/js/js_comparisons.asp">Porównanie JavaScript i operatory logiczne</span></u>
	</p>
...
Filtrowanie JavaScript: <span style="opacity: 0.5;">(Ciągi JavaScript)<br>
<input id="filter" class="round" type="text" value="content.equals('Lubię to!') && author.id === 'ID_czlonka'">
</div><br>
<div style="float: left; width: 50%;">
Maksymalna liczba wiadomości:<br>
<input id="max" class="round" type="text" value="1" placeholder="Opcjonalne"><br>
</div>
<div style="float: left; width: 49%;">
Maks. czas oczekiwania (w ms):<br>
<input id="time" class="round" type="text" value="60000" placeholder="Opcjonalne"><br>
</div><br><br><br>
    <div style="padding-top: 8px;">
        <div style="float: left; width: 35%;">
            Jeśli nastąpi odpowiedź:<br>
            <select id="iftrue" class="round" onchange="glob.onChangeTrue(this)">
					 <option value="0" selected>Kontyuuj akcję</option>
    ...
    <div style="padding-top: 8px;">
        <div style="float: left; width: 35%;">
            ...
            <select id="iffalse" class="round" onchange="glob.onChangeFalse(this)">
				<option value="0">Kontyuuj akcję</option>
				<option value="1" selected>Zatrzymaj sekwencję działania</option>
				<option value="2">Skocz do akcji</option>
				<option value="3">Pomiń następne akcje</option>
		 </select>
        </div>
