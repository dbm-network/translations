...
name: "Sprawdź dane serwerowe | Server Data",
...
<div style="padding-top: 8px;">
	...
	<div style="float: left; width: 45%;">
		...
		<select id="comparison" class="round">
			...
			<option value="1" selected>Równa się</option>
			<option value="2">Równa się dokładnie</option>
			<option value="3">Mniej niż</option>
			<option value="4">Więcej niż</option>
			<option value="5">Zawiera</option>
			<option value="6">Dopasowuje regularnie</option>
			<option value="7">Długość jest większa niż</option>
			<option value="8">Długość jest mniejsza niż</option>
			<option value="9">Długość równa się</option>
			<option value="10">Zaczyna się</option>
			<option value="11">Kończy się</option>
		</select>
	</div>
</div><br><br><br>
<div style="padding-top: 8px;">
