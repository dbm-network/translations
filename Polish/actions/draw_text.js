...
<div style="float: left; width: 50%;">
	Adres lokalny twojej czcionki (.fnt):<br>
...
<div style="float: right; width: 50%;">
	...
	<input id="width" class="round" type="text" placeholder="Zostaw puste jeśli nic!"><br>
	Pozycja (Y):<br>
	<input id="y" class="round" type="text" value="0"><br>
</div><br><br><br>
<div>
	Tekst:<br>
	<textarea id="text" rows="5" placeholder="Tutaj wstaw tekst..." style="width: 99%; white-space: nowrap; resize: none;"></textarea>
</div>`
},
