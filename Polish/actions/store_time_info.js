...
subtitle: function(data) {
	const time = ['Rok', 'Miesiąc (Numer)', 'Dzień w miesiącu', 'Godzina', 'Minuta', 'Sekunda', 'Milisekunda', 'Miesiąc (tekst.)'];
...
<div>
	<div style="padding-top: 8px; width: 70%;">
		...
		<select id="type" class="round">
			...
			<option value="1">Miesiąc (Numer)</option>
			<option value="7">Miesiąc (Tekst.)</option>
			<option value="2">Dzień w miesiącu</option>
			<option value="3">Godzina</option>
			<option value="4">Minuta</option>
			<option value="5">Sekunda</option>
			<option value="6">Milisekunda</option>
		</select>
	</div>
</div><br>
<div>
