...
subtitle: function(data) {
	const roles = ['Oznaczona rola', '1sza rola autora komendy', '1sza rola serwera', 'Zmienna tymczasowa', 'Zmienna serwerowa'];
...
<div style="padding-top: 8px;">
	Nazwa:<br>
	<input id="roleName" placeholder="Zostaw puste, aby nie edytować!" class="round" type="text">
</div><br>
<div style="float: left; width: 50%;">
	Wyświetl oddzielne od użyt. online:<br>
	<select id="hoist" class="round" style="width: 90%;">
		<option value="none" selected>Nie zmieniaj</option>
		<option value="true">Tak</option>
		<option value="false">Nie</option>
	</select><br>
	Możliwość wzmianki:<br>
...
<div style="float: right; width: 50%;">
	Kolor:<br>
	<input id="color" class="round" type="text" placeholder="Zostaw puste, aby nie edytować!"><br>
	Pozycja:<br>
	<input id="position" class="round" type="text" placeholder="Zostaw puste, aby nie edytować!" style="width: 90%;"><br>
</div>`
},
