...
name: "Ustaw uprawnienia kanału głosowego względem roli",
...
subtitle: function(data) {
	const names = ['Command Author\'s Voice Ch.', 'Mentioned User\'s Voice Ch.', 'Default Voice Channel', 'Zmienna tymczasowa', 'Zmienna serwerowa', 'Zmienna globalna'];
...
<div style="padding-top: 8px;">
	...
	<div style="padding-left: 5%; float: left; width: 55%;">
		...
		<select id="state" class="round">
			...
			<option value="1">Dziedzicz</option>
