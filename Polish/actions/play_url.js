...
<div style="float: right; width: 50%;">
	...
	<input id="volume" class="round" type="text" placeholder="Puste = automatyczne..."><br>
	Bitrate:<br>
	<input id="bitrate" class="round" type="text" placeholder="Puste = automatyczne...">
