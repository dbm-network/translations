...
subtitle: function(data) {
	const names = ['Ten sam kanał', 'Wspomniany kanał', 'Domyślny kanał', 'Zmienna tymczasowa', 'Zmienna serwerowa', 'Zmienna globalna'];
	const index = parseInt(data.storage);
	return index < 3 ? `Klonuj kanał : ${names[index]}` : `Klonuj kanał : ${names[index]} - ${data.varName}`;
},
...
<div>
	...
	<div style="padding-left: 2%; float: left; width: 45%;">
		...
		<select id="info" class="round" onchange="glob.channeltype(this)">
			<option value="0">Automatycznie (Klonuj wszystko)</option>
			<option value="1">Kanał tekstowy</option>
			<option value="2">Kanał głosowy</option>
		</select>
	</div>
</div><br><br><br>
<div id="text" style="display: none">
	<div style="float: left; width: 30%;">
		Klonuj temat kanału:<br>
