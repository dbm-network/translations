...
subtitle: function(data) {
	const info = ['ID kanału', 'nazwie kanału', 'temacie kanału'];
	return `Szukaj kanał po ${info[parseInt(data.info)]}`;
},
...
<div>
	<div style="float: left; width: 40%;">
		...
		<select id="info" class="round">
			<option value="0" selected>ID kanału</option>
			<option value="1">Nazwa kanału</option>
			<option value="2">Temat kanału</option>
		</select>
	</div>
