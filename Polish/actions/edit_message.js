...
subtitle: function(data) {
	const names = ['Wiadomość - komenda', 'Zmienna tymczasowa', 'Zmienna serwerowa', 'Zmienna globalna'];
...
<div style="padding-top: 8px;">
	Edytowana treść wiadomości:<br>
	<textarea id="message" rows="7" placeholder="Wstaw tutaj swoją wiadomość... (Opcjonalne)" style="width: 94%; font-family: monospace; white-space: nowrap; resize: none;"></textarea>
</div><br>
<div>
	<div style="float: left; width: 35%;">
		Źródło - embed:<br>
	...
	<div id="varNameContainer2" style="float: right; width: 60%;">
		Nazwa zmiennej:<br>
		<input id="varName2" placeholder="Opcjonalne" class="round" type="text" list="variableList"><br>
	</div>
</div>`
},
