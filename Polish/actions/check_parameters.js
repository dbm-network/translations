...
subtitle: function(data) {
	const results = ["Kontynnuj akcję", "Zatrzymaj sekwencję działania", "Skocz do akcji", "Pomiń następne akcje"];
	return `Jeśli prawda: ${results[parseInt(data.iftrue)]} ~ Jeśli fałsz: ${results[parseInt(data.iffalse)]}`;
},
...
<div>
	<div style="float: left; width: 45%;">
		...
		<select id="condition" class="round">
			<option value="0" selected>Liczba parametrów jest...</option>
			<option value="1">Liczba wspomnianych członków jest...</option>
			<option value="2">Liczba wspomnianych kanałów jest...</option>
			<option value="3">Liczba wspomnianych ról jest...</option>
		</select>
	</div>
