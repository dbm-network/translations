...
<div style="padding-top: 8px;">
	<div style="float: left; width: 45%;">
		Obraz, który jest wstawiany na obrazie:<br>
...
<div style="padding-top: 8px; width: 45%">
	...
	<select id="mask" class="round">
		<option value="0" selected>Pokryj</option>
		<option value="1">Zastąp</option>
		<option value="2">Maskuj</option>
	</select>
</div>`
},
