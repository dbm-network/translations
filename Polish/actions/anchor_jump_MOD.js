...
subtitle: function(data) {
	return !!data.description ? `<font color="${data.color}">${data.description}</font>` : `Skocz do ${!!data.jump_to_anchor ? `the "<font color="${data.color}">${data.jump_to_anchor}</font>" anchor in your command if it exists!` : 'an anchor!'}`;
},
...
<div>
		...
		<b>Jest to bardzo ważne, aby nazwa była taka sama, jak nazwa twojej kotwicy.</b>
	</p>
</div><br>
<div style="float: left; width: 74%;">
	Skocz do kotwicy o ID:<br>
