module.exports = {
	...
	section: "Zarządzanie zmiennymiS",
	...
	subtitle: function(data) {
		const info = ['Numer (liczby całkowite)', 'Numer (liczby rzeczywiste)', 'Ciąg znaków | String', 'Ciąg wielkich liter', 'Ciąg małych liter'];
		return `Typ konwersji: ${info[parseInt(data.conversion)]}`;
	},
	...
	<div>
		<div class="embed" style="width:98%;">
			<embedleftline></embedleftline><div class="embedinfo">
				...
				Stworzony przez ${this.author}</span><br>
				<span class="embed-desc">${this.short_description}<br>
				Wersja moda: ${this.version} | Dodany w wersji: 1.8.9</span>
			</div>
		</div>
	</div><br>
	<div>
	...
	<div>
		<div style="padding-top: 8px; width: 35%;">
			...
			<select id="conversion" class="round">
				<option value="0" selected>Numer (liczby całkowite)</option>
				<option value="1">Numer (liczby rzeczywiste)</option>
				<option value="2">Ciąg znaków | String</option>
				<option value="3">Ciąg wielkich liter</option>
				<option value="4">Ciąg małych liter</option>
			</select>
		</div>
	</div><br>
	<div>
