...
subtitle: function(data) {
	...
	const info = ['Znajdź według treści', 'Szukaj po ID wiadomości'];
...
<div id ="wrexdiv" style="width: 550px; height: 350px; overflow-y: scroll;">
	...
	<p>
		...
		Zmodyfikowany przez General Wrex!
	</p>
</div><br>
<div>
...
<div>
	<div style="float: left; width: 70%;">
		...
		<select id="info" class="round">
			<option value="0" selected>według treści</option>
			<option value="1">po ID wiadomości</option>
		</select>
	</div><br><br><br>
	<div style="float: left; width: 70%;">
		Szukaj:<br>
...
<div>
	<p>
	<u>Notatka:</u><br>
	Ten mod może znaleźć wiadomości tylko według <b>treści</b> w przedziale do 100 wiadomości.<br>
	Jeśli jest wiele wiadomości o tej samej treści, bot zawsze używa najstarszej wiadomości.
</div>`;
},
