...
subtitle: function(data) {
	const channels = ['Kanał głosowy autora komendy', 'Kanał głosowy oznaczonego członka', 'Domyślny kanał głosowy', 'Zmienna tymczasowa', 'Zmienna serwerowa', 'Zmienna globalna'];
