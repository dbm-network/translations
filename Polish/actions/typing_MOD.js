module.exports = {
	...
	subtitle: function(data) {
		...
		const names2 = ['Rozpoczyna pisanie', 'Końćzy pisanie']
	...
	html: function(isEvent, data) {
		...
		<div>
			<p>
				...
				Stworzony przez Lasse! (Połączony z modem autorstwa EliteArtz)
			</p>
		</div><br>
	<div>
		<div style="float: left; width: 35%;">
			...
			<select id="EliteArtzIsPro" class="round">
				<option value="0" selected>Rozpocznij pisanie</option>
				<option value="1">Zakończ pisanie</option>
			</select>
		</div><br>
	</div><br><br>
	<div>
		<div style="float: left; width: 35%;">
			Kanał na którym bot ma pisać:<br>
