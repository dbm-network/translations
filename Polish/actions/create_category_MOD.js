...
html: function(isEvent, data) {
	return `
	<div><p><u>Informacje o modzie:</u><br>Stworzony przez EliteArtz!</p><br>
		<p><u>Noty:</u><br>Wymaga Discord Bot Maker <b>BETA</b>!</p>
	</div><br>
	Nazwa:<br>
	<input id="channelName" class="round" type="text"><br>
	<div style="float: left; width: 50%;">
		Pozycja:<br>
		<input id="position" class="round" type="text" placeholder="Pozostaw puste, jeśli domyślne" style="width: 90%;"><br>
	</div><br><br><br><br>
<div>
