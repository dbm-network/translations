...
subtitle: function(data) {
	...
	return `Konwertuj wiek z formatu: ${info[data.info]}`;
},
...
html: function(isEvent, data) {
	...
	<div>
		<p>
			...
			Stworzony przez CoolGuy
		</p>
	</div><br>
<div style="width: 90%;">
	Zmienna daty lub ciąg znaków:<br>
...
action: function(cache) {
	...
	const monthsArr = ["stycznia", "lutego", "marca", "kwietnia", "maja", "czerwca", "lipca", "sierpnia", "września", "października", "listopada", "grudnia"];
