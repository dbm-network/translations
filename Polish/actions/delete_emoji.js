...
subtitle: function(data) {
	const inputTypes = ['Specyficzna emoji', 'Zmienna tymczasowa', 'Zmienna serwerowa', 'Zmienna globalna'];
...
<div>
	<div style="float: left; width: 35%;">
		...
		<select id="emoji" class="round" onchange="glob.onChange1(this)">
			<option value="0" selected>Specyficzna emoji</option>
	...
	<div id="varNameContainer" style="float: right; width: 60%;">
		<span id="extName">Nazwa emoji</span>:<br>
...
init: function() {
	...
	glob.onChange1 = function(event) {
		...
		if(value === 0) {
			varNameInput.innerHTML = "Nazwa emoji";
		} else {
			varNameInput.innerHTML = "Nazwa zmiennej";
		}
	};
