...
name: "Połącz z komendą/zdarzeniem",
...
subtitle: function(data) {
	...
	return `Połącz z komendą/zdarzeniem o ID "${source}"`;
},
...
html: function(isEvent, data) {
	return `
<div>
	<p>Ta akcja została zmodyfikowana przez DBM Mods.</p>
</div>
<div style="float: left; width: 85%; padding-top: 20px;">
	Źródło - typ:<br>
	<select id="sourcetype" class="round" onchange="glob.onChange1(this)">
		<option value="0" selected>Wybierz z listy</option>
		<option value="1">Wstaw ID komendy/zdarzenia</option>
	</select>
</div>
<div id="info1"; style="float: left; width: 85%; padding-top: 20px; display: none;">
	Komendy/zdarzenia:<br>
	<select id="source" class="round">
		<optgroup id="commands" label="Komendy"></optgroup>
		<optgroup id="events" label="Zdarzenia"></optgroup>
	</select>
</div>
<div id="info2" style="float: left; width: 94.5%; padding-top: 20px;">
	ID komendy/zdarzenia:<br>
	<input id="source2" class="round" type="text" placeholder="Wstaw tutaj ID komendy/zdarzenia...">
</div>
<div style="float: left; width: 85%; padding-top: 20px;">
	Rodzaj połączenia:<br>
	<select id="type" class="round">
	<option value="true" selected>Synchroniczny</option>
	<option value="false">Asynchroniczny</option>
	</select>
</div>`
},
