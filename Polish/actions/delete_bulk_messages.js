...
subtitle: function(data) {
	const channels = ['Ten sam kanał', 'Wspomniany kanał', '1st Server Channel', 'Zmienna tymczasowa', 'Zmienna serwerowa', 'Zmienna globalna'];
	return `Usuń ${data.count} wiadomości z kanału ${channels[parseInt(data.channel)] || 'Nic'}`;
},
