module.exports = {
	...
	section: "Zarządzanie Webhookami",
	...
	html: function (isEvent, data) {
		return `
<div><p><u>Informacje o modzie:</u><br>Stworzony przez Lasse!</p></div>
<div>
	<div style="float: left; width: 35%;">
		Wartość transferu z:<br>
...
<div style="float: left; width: 80%; padding-top: 8px;">
	...
	<select id="info" class="round">
		<option value="6" selected>Adres internetowy (URL)</option>
		...
		<option value="0">ID kanału</option>
	</select>
</div><br><br>
<div>
	<div style="float: left; width: 35%;">
