...
subtitle: function(data) {
	const roles = ['Wspomniana rola', '1sza rola autora komendy', '1sza rola na serwerze', 'Zmienna tymczasowa', 'Zmienna serwerowa', 'Zmienna globalna'];
