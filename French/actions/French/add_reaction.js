...
subtitle: function(data) {
	...
	return data.storage === "0" ? `Ajouter une réaction à ${names[index]}` : `Ajouter une réaction à ${names[index]} (${data.varName})`;
},
...
<div style="padding-top: 8px;">
	...
	<div id="varNameContainer2" style="float: right; width: 60%;">
		<span id="extName">Emoji  (clic-droit -> Insérer emoji)</span>:<br>
