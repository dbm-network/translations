...
<div>
	<div style="float: left; width: 45%;">
		...
		<select id="condition" class="round">
			<option value="0" selected>Le nombre d'arguments est...</option>
			<option value="1">Le nombre de mentions d'utilisateur est...</option>
			<option value="2">Le nombre de mentions de salon est...</option>
			<option value="3">Le nombre de mentions de rôle est...</option>
		</select>
	</div>
