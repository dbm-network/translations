...
name: "Ajouter un objet à une liste",
...
subtitle: function(data) {
	...
	return `Ajouter "${data.value}" à ${storage[parseInt(data.storage)]} (${data.varName})`;
},
...
<div style="padding-top: 8px;">
	<div style="float: left; width: 45%;">
		...
		<select id="addType" class="round" onchange="glob.onChange1(this)">
			<option value="0" selected>Ajouter à la fin</option>
			<option value="1">Ajouter au début</option>
			<option value="2">Ajouter à une position spécifique</option>
		</select>
	</div>
