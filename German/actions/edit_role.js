...
<div style="float: left; width: 50%;">
	Mitglieder gruppieren:<br>
	<select id="hoist" class="round" style="width: 90%;">
		<option value="none" selected>Nicht verändern</option>
...
<div style="float: right; width: 50%;">
	Farbe:<br>
	<input id="color" class="round" type="text" placeholder="Leer lassen um nichts zu ändern!"><br>
	Position:<br>
	<input id="position" class="round" type="text" placeholder="Leer lassen um nichts zu ändern!" style="width: 90%;"><br>
</div>`
},
