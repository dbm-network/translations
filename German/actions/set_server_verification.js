...
name: "Server Verifizierungs-Level festlegen",
...
subtitle: function(data) {
	const verifications = ['Keines', 'Niedrig', 'Mittelmäßig', '(╯°□°）╯︵ ┻━┻', '┻━┻彡 ヽ(ಠДಠ)ノ彡┻━┻﻿'];
