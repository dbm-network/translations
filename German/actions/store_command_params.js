...
name: "Befehls Parameter speichern",
...
subtitle: function(data) {
	const infoSources = ['Ein Parameter', 'Mehrere Parameters', 'Erwähnter Nutzer', 'Erwähnte Rolle', 'Erwähnter Kanal']
...
<div>
	<div style="float: left; width: 35%;">
		...
		<select id="info" class="round" onchange="glob.onChange1(this)">
			<option value="0" selected>Ein Parameter</option>
			<option value="1">Mehrere Parameters</option>
			<option value="2">Erwähnter Nutzer</option>
			<option value="3">Erwähnte Rolle</option>
			<option value="4">Erwähnter Kanal</option>
		</select>
	</div>
	<div style="float: right; width: 60%;">
		<div id="infoCountLabel">Parameter Nummer:</div>
