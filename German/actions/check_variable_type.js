...
<div style="padding-top: 8px; width: 80%;">
		Zu prüfende Variabel Art:<br>
		<select id="comparison" class="round">
			<option value="0" selected>Nummer</option>
			<option value="1">Zeichenfolge</option>
			<option value="2">Bild</option>
			<option value="3">Mitglied</option>
			<option value="4">Nachricht</option>
			<option value="5">Text Kanal</option>
			<option value="6">Sprach Kanal</option>
			<option value="7">Rolle</option>
