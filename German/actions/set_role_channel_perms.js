...
name: "Rollen Kanal Berechtigung festlegen",
...
subtitle: function(data) {
	const names = ['Befehls Nachricht', 'Temporäre Variabel', 'Serverweiten Variabel', 'Globale Variabel'];
...
<div style="padding-top: 8px;">
	...
	<div style="padding-left: 5%; float: left; width: 55%;">
		...
		<select id="state" class="round">
			...
			<option value="1">Übernehmen von Rolle</option>
