...
<div style="float: left; width: 50%;">
	...
	Qualitätsverbesserungs-Durchläufe:<br>
	<input id="passes" class="round" type="text" value="1">
</div>
<div style="float: right; width: 50%;">
	Lautstärke (0 = min; 100 = max):<br>
	<input id="volume" class="round" type="text" placeholder="Leer lassen für Automatik..."><br>
	Bitrate:<br>
	<input id="bitrate" class="round" type="text" placeholder="Leer lassen für Automatik...">
</div><br><br><br><br><br><br><br>
<div>
	Abspiel Art:<br>
	<select id="type" class="round" style="width: 90%;">
		<option value="0" selected>Zur Wiedergabeliste hinzufügen</option>
		<option value="1">Sofort abspielen (Wiedergabeliste ignorieren)</option>
	</select>
</div>`
},
