...
name: "Objekt aus Liste entfernen",
...
subtitle: function(data) {
	const storage = ['', 'Temporäre Variabel', 'Serverweite Variabel', 'Globale Variabel'];
	return `Objekt aus ${storage[parseInt(data.storage)]} (${data.varName}) entfernen`;
},
...
variableStorage: function(data, varType) {
	...
	return ([data.varName2, 'Unbekannte Art']);
},
...
<div style="padding-top: 8px;">
	<div style="float: left; width: 45%;">
		...
		<select id="removeType" class="round" onchange="glob.onChange1(this)">
			<option value="0" selected>Am Ende entfernen</option>
			<option value="1">Am Anfang entfernen</option>
			<option value="2">An einer speziellen Position entfernen</option>
		</select>
	</div>
