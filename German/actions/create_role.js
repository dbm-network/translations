...
<div style="float: right; width: 50%;">
	Farbe:<br>
	<input id="color" class="round" type="text" placeholder="Leer lassen für Standard!"><br>
	Position:<br>
	<input id="position" class="round" type="text" placeholder="Leer lassen für Standard!" style="width: 90%;"><br>
</div>
<div>
