...
<div style="float: left; width: 50%;">
	Bitrate:<br>
	<input id="bitrate" class="round" type="text" placeholder="Leer lassen für Standard!" style="width: 90%;"><br>
</div>
<div style="float: right; width: 50%;">
	Nutzer Limit:<br>
	<input id="userLimit" class="round" type="text" placeholder="Leer lassen für Standard!" style="width: 90%;"><br>
</div>
<div>
