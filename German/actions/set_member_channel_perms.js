...
name: "Mitglieder Kanal Berechtigung festlegen",
...
subtitle: function(data) {
	const names = ['Gleicher Kanal', 'Befehls Author', 'Erwähnter Nutzer', 'Erwähnter Kanal', 'Standard Kanal', 'Temporäre Variabel', 'Serverweite Variabel', 'Globale Variabel'];
...
<div style="padding-top: 8px;">
	...
	<div style="padding-left: 5%; float: left; width: 55%;">
		...
		<select id="state" class="round">
			<option value="0" selected>Erlauben</option>
			<option value="1">Übernehmen von Rollen</option>
