...
subtitle: function(data) {
	const statuses = ["Online", "Abwesend", "Unsichtbar", "Bitte nicht stören"];
...
<div style="float: left; width: 70%;">
	...
	<select id="status" class="round">
		...
		<option value="2">Unsichtbar</option>
		<option value="3">Bitte nicht stören</option>
	</select>
</div>`
},
