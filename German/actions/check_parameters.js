...
<div>
	<div style="float: left; width: 45%;">
		...
		<select id="condition" class="round">
			<option value="0" selected>Anzahl an Parametern ist...</option>
			<option value="1">Anzahl an erwähnten Mitgliedern sind...</option>
			<option value="2">Anzahl an erwähnten Kanälen sind...</option>
			<option value="3">Anzahl an erwähnten Rollen sind...</option>
		</select>
	</div>
