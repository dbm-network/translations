...
name: "Kanal Berechtigung festlegen",
...
subtitle: function(data) {
	const names = ['Erwähnter Nutzer', 'Befehls Author', 'Temporäre Variabel', 'Serverweite Variabel', 'Globale Variabel'];
...
<div style="padding-top: 8px;">
	...
	<div style="padding-left: 5%; float: left; width: 55%;">
		...
		<select id="state" class="round">
			...
			<option value="1">Verbieten</option>
		</select>
	</div>
</div>`
},
