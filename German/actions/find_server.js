...
subtitle: function(data) {
	const info = ['Server ID', 'Server Name', 'Abkürzung des Servernamen', 'Server Mitglieder Anzahl', 'Server Region', 'Server Inhaber ID', 'Server Verifizierungs Stufe', 'Server is verfügbar'];
	return `Server finden mittels ${info[parseInt(data.info)]}`;
},
...
<div>
	<div style="float: left; width: 40%;">
		...
		<select id="info" class="round">
			...
			<option value="2">Abkürzung des Servernamen</option>
			<option value="3">Server Mitglieder Anzahl</option>
			<option value="4">Server Region</option>
			<option value="5">Server Inhaber ID</option>
			<option value="6">Server Verifizierungs Stufe</option>
			<option value="7">Server ist verfügbar</option>
		</select>
	</div>
