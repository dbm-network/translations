...
name: "Objekt zur Liste hinzufügen",
...
subtitle: function(data) {
	const storage = ['', 'Temporären Variabel', 'Serverweiten Variabel', 'Globalen Variabel'];
	return `Füge "${data.value}" zur ${storage[parseInt(data.storage)]} (${data.varName}) hinzu`;
},
...
<div style="padding-top: 8px;">
	<div style="float: left; width: 45%;">
		...
		<select id="addType" class="round" onchange="glob.onChange1(this)">
			<option value="0" selected>Am Ende anfügen</option>
			<option value="1">Am Anfang anfügen</option>
			<option value="2">An einer speziellen Position einfügen</option>
		</select>
	</div>
