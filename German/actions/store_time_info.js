...
subtitle: function(data) {
	const time = ['Jahr', 'Monat', 'Tag des Monats', 'Stunde', 'Minute', 'Sekunde', 'Millisekunde'];
...
<div>
	<div style="padding-top: 8px; width: 70%;">
		...
		<select id="type" class="round">
			...
			<option value="1">Monat (Nummer)</option>
			<option value="7">Monat (Text)</option>
			<option value="2">Tag des Monats</option>
			<option value="3">Stunde</option>
			<option value="4">Minute</option>
			<option value="5">Sekunde</option>
			<option value="6">Millisekunde</option>
		</select>
	</div>
</div><br>
<div>
