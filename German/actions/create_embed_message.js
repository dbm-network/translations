...
name: "Eingebettete Nachricht erstellen",
...
variableStorage: function(data, varType) {
	...
	return ([data.varName, 'Eingebettete Nachricht']);
},
...
<div style="float: left; width: 50%;">
	...
	Farbe:<br>
	<input id="color" class="round" type="text" placeholder="Leer lassen für die Standard Farbe!"><br>
	Zeitstämpel verwenden:<br>
...
<div style="float: right; width: 50%;">
	URL:<br>
	<input id="url" class="round" type="text" placeholder="Leer lassen für keine!"><br>
	Author Symbol URL:<br>
	<input id="authorIcon" class="round" type="text" placeholder="Leer lassen für keine!"><br>
	Bild URL:<br>
	<input id="imageUrl" class="round" type="text" placeholder="Leer lassen für keine!"><br>
	Vorschau-Bild URL:<br>
	<input id="thumbUrl" class="round" type="text" placeholder="Leer lassen für keine!"><br>
</div>
<div>
