...
subtitle: function(data) {
	const channels = ['Befehls Author\'s Sprachkanal', 'Erwähntem Nutzer\'s Sprachkanal', 'Standard Sprachkanal', 'Temporäre Variabel', 'Serverweite Variabel', 'Globale Variabel'];
