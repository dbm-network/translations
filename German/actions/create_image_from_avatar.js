...
name: "Bild aus Avatar erstellen",
...
subtitle: function(data) {
	const channels = ['Erwähnter Nutzer', 'Befehls Author', 'Temporäre Variabel', 'Server Variabel', 'Globale Variabel'];
