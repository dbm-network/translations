...
subtitle: function(data) {
	...
	return `Event ID "${data.source}" mit jedem Objekt der "${list[parseInt(data.list)]}" Liste aufrufen`;
},
...
<div>
	...
	<div id="varNameContainer" style="float: right; width: 60%;">
		Temporäre Variabel Name:<br>
		<input id="varName" class="round" type="text" list="variableList"><br>
	</div>
</div><br><br><br><br>
<div style="width: 95%;">
	Temporäre Variabel Name (Speichert alle <span id="tempName">Mitglieder</span> während der Schleife):<br>
...
<div style="width: 85%;">
	...
	<select id="type" class="round">
		<option value="true" selected>Synchron</option>
		<option value="false">Asynchron</option>
	</select>
</div>`
},
