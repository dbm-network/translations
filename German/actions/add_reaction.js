...
subtitle: function(data) {
	const names = ['Befehls Nachricht', 'Temporären Variabel', 'Serverweiten Variabel', 'Globalen Variabel'];
	const index = parseInt(data.storage);
	return data.storage === "0" ? `Füge eine Reaktion zur ${names[index]} hinzu` : `Füge eine Reaktion zur ${names[index]} (${data.varName}) hinzu`;
},
...
<div style="padding-top: 8px;">
	<div style="float: left; width: 35%;">
		...
		<select id="emoji" name="second-list" class="round" onchange="glob.onChange1(this)">
			<option value="4" selected>Direktes Emoji</option>
			<option value="0">BeMitglieddefiniertes Emoji</option>
			<option value="1">Temporäre Variabel</option>
			<option value="2">Serverweite Variabel</option>
			<option value="3">Globale Variabel</option>
		</select>
	</div>
	<div id="varNameContainer2" style="float: right; width: 60%;">
		<span id="extName">Emoji  (Rechts-Klick -> Emoji einfügen)</span>:<br>
