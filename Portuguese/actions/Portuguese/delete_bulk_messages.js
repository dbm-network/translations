...
name: "Excluir Mensagens em Massa",
...
subtitle: function(data) {
	const channels = ['Mesmo Canal', 'Canal Mencionado', '1º Canal do Servidor', 'Variavel Temporária', 'Variavel de Servidor', 'Variavel Global'];
