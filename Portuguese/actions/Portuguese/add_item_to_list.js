...
subtitle: function(data) {
	const storage = ['', 'Variavel Temporária', 'Variavel de Servidor', 'Variavel Global'];
...
<div style="padding-top: 8px;">
	<div style="float: left; width: 45%;">
		Tipo de Adicionar:<br>
		<select id="addType" class="round" onchange="glob.onChange1(this)">
			<option value="0" selected>Adicionar ao Fim</option>
			<option value="1">Adicionar ao Inicio</option>
			<option value="2">Adicionar a uma Posição Específica</option>
		</select>
	</div>
