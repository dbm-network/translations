...
subtitle: function(data) {
	const members = ['Usuário Mencionado', 'Autor do Comando', 'Variavel Temporária', 'Variavel de Servidor', 'Variavel Global'];
...
<div style="padding-top: 8px;">
	Motivo:<br>
	<textarea id="reason" rows="5" placeholder="Insere o motivo aqui..." style="width: 99%; font-family: monospace; white-space: nowrap; resize: none;"></textarea>
</div>`
},
