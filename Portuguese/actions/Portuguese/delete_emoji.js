...
subtitle: function(data) {
	const inputTypes = ['Emoji Específico', 'Variavel Temporária', 'Variavel de Servidor', 'Variavel Global'];
...
<div>
	<div style="float: left; width: 35%;">
		...
		<select id="emoji" class="round" onchange="glob.onChange1(this)">
			<option value="0" selected>Emoji Específico</option>
			<option value="1">Variavel Temporária</option>
			<option value="2">Variavel de Servidor</option>
			<option value="3">Variavel Global</option>
		</select>
	</div>
	<div id="varNameContainer" style="float: right; width: 60%;">
		<span id="extName">Nome do Emoji</span>:<br>
