...
subtitle: function(data) {
	const results = ["Continuar Ações", "Parar a Sequência de Ações", "Saltar para a Ação", "Saltar Ações á Frente"];
...
<div>
	<div style="float: left; width: 45%;">
		...
		<select id="condition" class="round">
			<option value="0" selected>Número de Parametros é...</option>
			<option value="1">Número de Menções de Usuários é...</option>
