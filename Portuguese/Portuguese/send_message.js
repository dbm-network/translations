...
subtitle: function(data) {
	const channels = ['Mesmo Canal', 'Autor do Comando', 'Usuário Mencionado', 'Canal Mencionado', 'Canal Padrão', 'Variavel Temporária', 'Variavel de Servidor', 'Variavel Global'];
...
<div style="padding-top: 8px;">
	Mensagem:<br>
	<textarea id="message" rows="9" placeholder="Insere a mensagem aqui..." style="width: 99%; font-family: monospace; white-space: nowrap; resize: none;"></textarea>
</div><br>
<div>
	<div style="float: left; width: 35%;">
		Guardar em:<br>
