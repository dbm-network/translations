...
<div style="width: 85%;">
	...
	<select id="source" class="round">
		<optgroup id="commands" label="Comandos"></optgroup>
		<optgroup id="events" label="Eventos"></optgroup>
	</select><br>
	Tipo de Acionar:<br>
	<select id="type" class="round">
		<option value="true" selected>Síncrono</option>
