...
name: "Efectos de Imagen customizados",
...
//---------------------------------------------------------------------
	 ...
	 short_description: "Agrega efectos con una intensidad customizada",
...
<div style="padding-top: 8px;">
	<div style="float: left; width: 90%;">
		...
		<select id="effect" class="round">
			<option value="0" selected>Blur customizado</option>
			<option value="1">Pixelación customizada</option>
		</select><br>
	</div>
