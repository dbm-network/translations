...
subtitle: function(data) {
	const channels = ['Erwähnter Mitglied', 'Befehls Author', 'Temporäre Variabel', 'Server Variabel', 'Globale Variabel'];
...
<div style="padding-top: 8px;">
	Grund:<br>
	<textarea id="reason" rows="5" placeholder="Füge einen Grund hier ein..." style="width: 99%; font-family: monospace; white-space: nowrap; resize: none;"></textarea>
</div>`
},
