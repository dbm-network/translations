...
subtitle: function(data) {
	const inputTypes = ['Spezifisches Emoji', 'Temporäre Variabel', 'Serverweite Variabel', 'Globale Variabel'];
...
<div>
	<div style="float: left; width: 35%;">
		...
		<select id="emoji" class="round" onchange="glob.onChange1(this)">
			<option value="0" selected>Spezifisches Emoji</option>
