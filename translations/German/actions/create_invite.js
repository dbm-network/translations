...
name: "Server Einladung erstellen",
...
subtitle: function(data) {
	const names = [
		...
		'1er Server Kanal', 
		'Temporäre Variabel', 
		'Serverweite Variabel', 
		'Globale Variabel'
	];
	const index = parseInt(data.storage);
	return parseInt(data.storage) < 3 ? `Einladung zu ${names[index]}` : `Einladung zu ${names[index]} (${data.varName})`;
},
...
<div style="padding-top: 8px;">
	<div style="float: left; width: 70%;">
		Maximale Benutzung:<br>
		<input id="maxUses" class="round" type="text" placeholder="Leer lassen, für unendliche Benutzung!"><br>
		Geltungszeit (in Sekunden):<br>
		<input id="lifetime" class="round" type="text" placeholder="Leer lassen, für unendliche Geltungszeit!"><br>
	</div>
	<div style="float: right; width: 30%;">
		Vorübergehende Mitgliedschaft:<br>
		<select id="tempInvite" class="round" style="width: 90%;">
			<option value="true">Ja</option>
			<option value="false" selected>Nein</option>
		</select><br>
		Einzigartige Einladung:<br>
