...
<div style="padding-top: 8px; width: 90%;">
	...
	<select id="region" class="round">
		...
		<option value="eu-central">EU Zentral</option>
		<option value="hongkong">HongKong</option>
		<option value="us-south">US Süd</option>
		<option value="us-central">US Zentral</option>
		<option value="london">London</option>
		<option value="us-east">US Ost</option>
