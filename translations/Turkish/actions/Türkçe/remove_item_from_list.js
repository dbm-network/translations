...
<div style="padding-top: 8px;">
	<div style="float: left; width: 45%;">
		...
		<select id="removeType" class="round" onchange="glob.onChange1(this)">
			<option value="0" selected>Sonundan kaldır</option>
			<option value="1">Önünden kaldır</option>
			<option value="2">Belirli Konumdan Kaldır</option>
		</select>
	</div>
