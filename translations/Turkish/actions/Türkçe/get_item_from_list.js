...
subtitle: function(data) {
	const list = ['Sunucu Üyeleri', 'Sunucu Channels', 'Sunucu Roles', 'Sunucu Emojis', 'Tüm Bot Sunucuları', 'Etiketli Kullanıcının Rolleri', 'Komutu Yazanın Rolleri', 'Geçici Değişken', 'Sunucu Değişkeni', 'Evrensel Değişken'];
...
<div style="padding-top: 8px;">
	<div style="float: left; width: 45%;">
		...
		<select id="getType" class="round" onchange="glob.onChange1(this)">
			<option value="0" selected>İlk Eşya</option>
			<option value="1">Son eşya</option>
			<option value="2">Rastgele Eşya</option>
			<option value="3">Konumdaki Öğe</option>
		</select>
	</div>
