...
<div>
	<div style="float: left; width: 45%;">
		...
		<select id="behavior" class="round">
			<option value="0" selected>Sonraki İşlemi Otomatik Çağır</option>
			<option value="1">Sonraki İşlemi Çağırma</option>
		</select>
	</div>
	<div style="padding-left: 5%; float: left; width: 55%;">
		Yorumlama Stili:<br>
		<select id="interpretation" class="round">
			<option value="0" selected>Önce Metni Değerlendirin</option>
			<option value="1">Metni Doğrudan Değerlendirin</option>
		</select>
	</div>
</div><br><br><br>
