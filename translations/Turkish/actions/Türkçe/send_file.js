...
subtitle: function(data) {
	const channels = ['Aynı Kanal', 'Komutu Yazan', 'Etiketlenen Kullanıcı', 'Etiketlenen Kanal', 'Varsayılan Kanal', 'Geçici Değişken', 'Sunucu Değişkeni', 'Evrensel Değişken'];
...
<div style="padding-top: 8px;">
	Yerel Dosyanın URL:<br>
	<input id="file" class="round" type="text" value="kaynaklar/"><br>
</div>
<div>
	Mesaj:<br>
	<textarea id="message" rows="8" placeholder="Mesajını buraya gir..." style="width: 99%; font-family: monospace; white-space: nowrap; resize: none;"></textarea>
</div>`
},
