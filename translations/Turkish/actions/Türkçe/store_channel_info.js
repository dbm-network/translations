...
subtitle: function(data) {
	const channels = ['Aynı Kanal', 'Etiketli Kanal', 'Sunucunun 1. Kanalı', 'Geçici Değişken', 'Sunucu Değişkeni', 'Evrensel Değişken'];
	const info = ['Kanalın Etiketli Hali', 'Kanal ID', 'Kanal Adı', 'Kanal Konusu', 'Kanal Son Mesajı', 'Kanal Konumu', 'Kanal NSFW?'];
...
<div>
	<div style="padding-top: 8px; width: 70%;">
		...
		<select id="info" class="round">
			<option value="0" selected>Kanalın Etiketli Hali</option>
			<option value="1">Kanal ID</option>
			<option value="2">Kanal Adı</option>
			<option value="3">Kanal Konusu</option>
			<option value="4">Kanal Son Mesajı</option>
			<option value="5">Kanal Konumu</option>
			<option value="6">Kanal NSFW?</option>
			<option value="7">Kanal DM?</option>
		</select>
	</div>
</div><br>
<div>
