...
<div style="float: right; width: 50%;">
	Renk:<br>
	<input id="color" class="round" type="text" placeholder="Varsayılan için boş bırakın!"><br>
	Konum:<br>
	<input id="position" class="round" type="text" placeholder="Varsayılan için boş bırakın!" style="width: 90%;"><br>
</div>
<div>
