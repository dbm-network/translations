...
subtitle: function(data) {
	...
	const mirror = ["Ayna Yok", "Yatay Ayna", "Dikey Ayna", "Çapraz Ayna"];
...
<div style="padding-top: 8px;">
	<div style="float: left; width: 45%;">
		...
		<select id="mirror" class="round">
			<option value="0" selected>Hiçbirşey</option>
			<option value="1">Yatay Ayna</option>
			<option value="2">Dikey Ayna</option>
			<option value="3">Çapraz Ayna</option>
		</select><br>
	</div>
