...
subtitle: function(data) {
	const info = ['Kategori ID', 'Kategori Adı', 'Kategori Konusu'];
...
short_description: "ID veya adıyla Kategoriyi bul.",
...
html: function(isEvent, data) {
	...
	<p>
		<u>Mod Bilgisi:</u><br>
		NetLuis tarafından oluşturuldu!<br>
		Fikir sahibi SAFAxSNIPER
	</p>
</div><br>
<div>
	<div style="float: left; width: 40%;">
		...
		<select id="info" class="round">
			<option value="0" selected>Kategori ID</option>
			<option value="1">Kategori Adı</option>
		</select>
	</div>
