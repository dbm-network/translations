...
<div style="width: 85%;">
	...
	<select id="source" class="round">
		<optgroup id="commands" label="Komutlar"></optgroup>
		<optgroup id="events" label="Eylemler"></optgroup>
	</select><br>
	Tür Çağır:<br>
	<select id="type" class="round">
		<option value="true" selected>Senkronize</option>
		<option value="false">Senkronize Olmayan</option>
	</select>
</div>`
},
