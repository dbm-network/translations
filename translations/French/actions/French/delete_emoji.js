...
subtitle: function(data) {
	const inputTypes = ['Emoji spécifique', 'Temp Variable', 'Server Variable', 'Global Variable'];
...
<div>
	<div style="float: left; width: 35%;">
		...
		<select id="emoji" class="round" onchange="glob.onChange1(this)">
			<option value="0" selected>Emoji spécifique</option>
	...
	<div id="varNameContainer" style="float: right; width: 60%;">
		<span id="extName">Nom de l'emoji</span>:<br>
