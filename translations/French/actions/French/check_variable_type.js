...
name: "Vérifier le type de variable",
...
<div style="padding-top: 8px; width: 80%;">
		...
		<select id="comparison" class="round">
			...
			<option value="5">Salon textuel</option>
			<option value="6">Salon vocal</option>
			<option value="7">Rôle</option>
			<option value="8">Serveur</option>
