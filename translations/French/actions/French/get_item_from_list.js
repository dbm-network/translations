...
name: "Stocker un objet d'une liste",
...
subtitle: function(data) {
	...
	return `Stocker un objet de ${list[parseInt(data.list)]}`;
},
...
<div style="padding-top: 8px;">
	<div style="float: left; width: 45%;">
		...
		<select id="getType" class="round" onchange="glob.onChange1(this)">
			<option value="0" selected>Premier objet</option>
			<option value="1">Dernier objet</option>
			<option value="2">Objet aléatoire</option>
			<option value="3">Objet à la position</option>
		</select>
	</div>
