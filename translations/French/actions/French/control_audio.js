...
subtitle: function(data) {
	const actions = ["Arrêter", "Pause", "Reprendre"];
...
<div style="float: left; width: 80%;">
	Action de l'audio:<br>
	<select id="action" class="round">
		<option value="0" selected>Arrêter</option>
		<option value="1">Pause</option>
		<option value="2">Reprendre</option>
	</select>
</div>`;
},
