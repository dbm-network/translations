...
subtitle: function(data) {
	const roles = ['Cargo Mencionado', '1º Cargo do Autor', '1º Cargo do Servidor', 'Variavel Temporária', 'Variavel de Servidor', 'Variavel Global'];
	const channels = ['Usuário Mencionado', 'Autor do Comando', 'Variavel Temporária', 'Variavel de Servidor', 'Variavel Global'];
